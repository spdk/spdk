...
read the csts register of controllers in the monitor function of the hotplug, if the
device hot removed, the register will be all "F", then the dirver know that the device
is removed.
