...
read the csts register when admin command complete, if the device hot removed, the register
will be all "F", then the dirver know that the device is removed.
