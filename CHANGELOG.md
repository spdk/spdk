...
DIF strip and insert feature has been supported. Any DIF setting is not exposed to the iSCSI
initiator, and DIF is attached to data for write I/O and strip from data for read I/O.
