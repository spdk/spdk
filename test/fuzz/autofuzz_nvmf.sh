...
$NVMF_APP -m 0xF >$output_dir/nvmf_autofuzz_tgt_output.txt 2>&1 &
nvmfpid=$!
...
$rootdir/test/app/fuzz/nvme_fuzz/nvme_fuzz -m 0xF0 -r "/var/tmp/nvme_fuzz" -t 1200 -C $testdir/nvmf_fuzz.conf -N -a 2>$output_dir/nvmf_autofuzz_logs.txt
