...
# "--compile-with-lto" - By default this script will compile SPDK with link time optimization gcc flag. Set this flag to false in CI environments where SPDK is already compiled with lto prior to this test.
