...
result_dir=perf_results_${MIX}_${PLUGIN}_${no_cores}cpus_${date}
mkdir $BASE_DIR/results/$result_dir
result_file=$BASE_DIR/results/$result_dir/perf_results_${MIX}_${PLUGIN}_${no_cores}cpus_${date}.csv
