...
trap 'set -e; rm -f *.state $nvme_fio_results $BASE_DIR/bdev.conf; print_backtrace; echo -1 > /sys/block/nvme0n1/queue/io_poll_delay; print_backtrace' ERR SIGTERM SIGABRT
. $BASE_DIR/common.sh
