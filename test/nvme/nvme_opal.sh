...
function opal_test_environment() {
	...
	$rpc_py destruct_opal_vbdev -b nvme0n1l2 -p test
	$rpc_py destruct_opal_vbdev -b nvme1n1l1 -p test
	...
	$rpc_py construct_opal_vbdev -b nvme0n1 -i 3 -s 4096 -l 4096 -p test
	$rpc_py construct_opal_vbdev -b nvme1n1 -i 3 -s 4096 -l 4096 -p test
	$rpc_py bdev_get_bdevs
}
