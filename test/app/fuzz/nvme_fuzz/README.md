...
application will continue to submit I/O until the run time is expired (see the -t flag), the
target stops completing back the I/O we submit to it for a period of five seconds or more, you
specified a json file containing commands and all of them have been submitted to the target and completed.
