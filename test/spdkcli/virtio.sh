...
MATCH_FILE="spdkcli_virtio.test"
...
timing_enter spdkcli_create_virtio_config
...
timing_exit spdkcli_create_virtio_config

python3 $SPDKCLI_BUILD_DIR/scripts/spdkcli.py ll
