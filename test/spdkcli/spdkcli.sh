...
$spdk_rpc_py get_vhost_controllers
python3 $SPDK_BUILD_DIR/scripts/spdkcli.py ll > $out_file
#python3 $SPDK_BUILD_DIR/scripts/spdkcli.py bdevs/split_disk/Nvme0n1p0 show_details  > $out_file_details
