...
function run_pmem_test() {
	...
	$SPDK_BUILD_DIR/scripts/spdkcli.py ll > $testdir/spdkcli.test_pmem
	$SPDK_BUILD_DIR/test/app/match/match -v $testdir/spdkcli.test_pmem".match"
