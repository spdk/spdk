...
$spdkcli_job "/nvmf/subsystem create nqn.2014-08.org.spdk:cnode1 N37SXV509SRW\
 listen=trtype:RDMA-traddr:10.0.2.15-trsvcid:4260\
 namespaces=Malloc3:1=Malloc4:2 max_namespaces=2 allow_any_host=True" "nqn.2014-08.org.spdk:cnode1" True
$spdkcli_job "/nvmf/subsystem create nqn.2014-08.org.spdk:cnode2 N37SXV509SRD\
 listen=trtype:RDMA-traddr:10.0.2.15-trsvcid:4260\
 namespaces=Malloc1 max_namespaces=2 allow_any_host=True" "nqn.2014-08.org.spdk:cnode2" True
$spdkcli_job "/nvmf/subsystem create nqn.2014-08.org.spdk:cnode3 N37SXV509SRR\
 listen=trtype:RDMA-traddr:10.0.2.15-trsvcid:4260=trtype:RDMA-traddr:10.0.2.15-trsvcid:4261\
 hosts=nqn.2014-08.org.spdk:cnode1=nqn.2014-08.org.spdk:cnode2\
 namespaces=Malloc2 max_namespaces=2 allow_any_host=True" "nqn.2014-08.org.spdk:cnode2" True
$spdkcli_job "/nvmf/subsystem/nqn.2014-08.org.spdk:cnode1 allow_any_host 0" "Allow any host"
$spdkcli_job "/nvmf/subsystem/nqn.2014-08.org.spdk:cnode1 allow_any_host 1" "Allow any host" True
$spdkcli_job "/nvmf/subsystem/nqn.2014-08.org.spdk:cnode1/listen_addresses create RDMA 10.0.2.15 4261 IPv4" "10.0.2.15:4261" True
$spdkcli_job "/nvmf/subsystem/nqn.2014-08.org.spdk:cnode1/listen_addresses create RDMA 10.0.2.15 4262 IPv4" "10.0.2.15:4262" True
...
$spdkcli_job "/nvmf/subsystem/nqn.2014-08.org.spdk:cnode1/namespaces delete" "Malloc4"
...
$spdkcli_job "/nvmf/subsystem/nqn.2014-08.org.spdk:cnode3/hosts delete" "nqn.2014-08.org.spdk:cnode2"
$spdkcli_job "/nvmf/subsystem/nqn.2014-08.org.spdk:cnode1/listen_addresses delete 10.0.2.15 4262" "10.0.2.15:4262"
$spdkcli_job "/nvmf/subsystem/nqn.2014-08.org.spdk:cnode1/listen_addresses delete" "10.0.2.15:4261"
