...
$spdkcli_job "/nvmf/subsystem create nqn.2014-08.org.spdk:cnode1 N37SXV509SRW\
 listen=trtype:RDMA-traddr:$NVMF_TARGET_IP-trsvcid:4260\
...
$spdkcli_job "/nvmf/subsystem create nqn.2014-08.org.spdk:cnode3 N37SXV509SRR\
 listen=trtype:RDMA-traddr:$NVMF_TARGET_IP-trsvcid:4260=trtype:RDMA-traddr:$NVMF_TARGET_IP-trsvcid:4261\
...
$spdkcli_job "/nvmf/subsystem/nqn.2014-08.org.spdk:cnode1/listen_addresses delete $NVMF_TARGET_IP 4262" "$NVMF_TARGET_IP:4262"
$spdkcli_job "/nvmf/subsystem/nqn.2014-08.org.spdk:cnode1/listen_addresses delete" "$NVMF_TARGET_IP:4261"
