...
$spdkcli_job "/iscsi/initiator_groups create 2 ANY 10.0.2.15/32" "ANY 10.0.2.15/32" True
$spdkcli_job "/iscsi/initiator_groups create 3 ANZ 10.0.2.15/32" "ANZ 10.0.2.15/32" True
$spdkcli_job "/iscsi/initiator_groups add_initiator 2 ANW 10.0.2.16/32" "ANW 10.0.2.16" True
$spdkcli_job "/iscsi/target_nodes create Target0 Target0_alias Malloc0:0-Malloc1:1 1:2 64 d=1" "Target0" True
$spdkcli_job "/iscsi/target_nodes create Target1 Target1_alias Malloc2:0 1:2 64 d=1" "Target1" True
$spdkcli_job "/iscsi/target_nodes/iqn.2016-06.io.spdk:Target0 add_pg_ig_maps 1:3-2:2" "PG:1 IG:3" True
...
$spdkcli_job "/iscsi/target_nodes/iqn.2016-06.io.spdk:Target0 set_auth chap_group=1 disable_chap=true" "disable_chap: True" True
...
$spdkcli_job "/iscsi/target_nodes/iqn.2016-06.io.spdk:Target0 delete_pg_ig_maps 1:3-2:2" "PG:1 IG:3"
