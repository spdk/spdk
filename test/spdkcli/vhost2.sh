...
$spdkcli_job_m "\"/bdevs/malloc create 40 512 Malloc0\" \"Malloc0\" True
...
$spdkcli_job_m "\"/bdevs/aio create sample0 /tmp/sample_aio 512\" \"sample0\" True
...
$spdkcli_job_m "\"/bdevs/nvme create Nvme0 $trtype $traddr\" \"Nvme0\" True
...
$spdkcli_job_m "\"/lvol_stores create lvs Malloc0\" \"lvs\" True
\"/bdevs/logical_volume create lvol0 16 lvs\" \"lvs/lvol0\" True
\"/bdevs/logical_volume create lvol1 16 lvs\" \"lvs/lvol1\" True
"
timing_exit spdkcli_create_lvols_config

timing_enter spdkcli_create_vhosts_config
$spdkcli_job_m "\"vhost/block create vhost_blk1 Nvme0n1p0\" \"Nvme0n1p0\" True
...
$spdkcli_job_m "\"save_config $testdir/config.json\"
...
$spdkcli_job_m "\"vhost/scsi/vhost_scsi2 remove_target 2\" \"Nvme0n1p3\"
...
\"/bdevs/logical_volume delete lvs/lvol0\" \"lvs/lvol0\"
\"/bdevs/logical_volume delete_all\" \"lvs/lvol1\"
\"/lvol_stores delete lvs\" \"lvs\"
...
$spdkcli_job_m "\"load_config $testdir/config.json\"
\"/lvol_stores create lvs Malloc0\" \"lvs\" True
\"/bdevs/logical_volume create lvol0 16 lvs\" \"lvs/lvol0\" True
\"/bdevs/logical_volume create lvol1 16 lvs\" \"lvs/lvol1\" True
"
check_match
...
sleep 2
$spdkcli_job_m "\"load_subsystem_config $testdir/config_bdev.json\"
