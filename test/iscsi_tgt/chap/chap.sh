...
# TODO: CHAP authentication fails due to unknown reason when veth interface is used.
# Hence use local loopback for now.
...
$rpc_py add_iscsi_auth_group 1 -c 'user:host1 secret:hsecret1'
# For bidirectional CHAP
$rpc_py add_iscsi_auth_group 2 -c 'user:host2 secret:hsecret2 muser:target2 msecret:tsecret2'
