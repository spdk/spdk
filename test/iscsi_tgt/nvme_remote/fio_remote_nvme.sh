...
function run_nvme_remote() {
	...
	trap "killprocess $iscsipid; killprocess $nvmfpid; nvmftestfini $1; iscsitestfini $1 $2; exit 1" SIGINT SIGTERM EXIT
...
trap "killprocess $nvmfpid; nvmftestfini $1; iscsitestfini $1 $2; exit 1" SIGINT SIGTERM EXIT
...
trap "iscsicleanup; killprocess $iscsipid; killprocess $nvmfpid; \
	rm -f ./local-job0-0-verify.state; nvmftestfini $1; iscsitestfini $1 $2; exit 1" SIGINT SIGTERM EXIT
sleep 1
