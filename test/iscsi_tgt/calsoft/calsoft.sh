...
echo AuthFile /usr/local/etc/auth.conf
echo DiscoveryAuthGroup AuthGroup1
echo MaxSessions 256
echo MaxR2T 256
echo ErrorRecoveryLevel 2
echo NopInInterval 10
echo AllowDuplicateIsid Yes
EOF
