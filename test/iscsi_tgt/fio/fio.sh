...
[ `$rootdir/scripts/gen_nvme.sh | wc -l` -eq 1 ] && exit
...
lb_name=$($rpc_py construct_lvol_bdev -u $ls_guid lbd0 $(($(get_lvs_free_mb $ls_guid)/10)))
...
if [ $RUN_NIGHTLY -eq 1 ]; then
	$fio_py 4096 1 write 10 verify
	$fio_py 4096 1 randwrite 10 verify
	$fio_py 131072 32 randrw 10 verify
	$fio_py 1048576 128 rw 30 verify
