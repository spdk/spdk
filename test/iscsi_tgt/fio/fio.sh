...
sleep 1
$fio_py iscsi 4096 1 randrw 1 verify 1
$fio_py iscsi 131072 32 randrw 1 verify 1
$fio_py iscsi 524288 128 randrw 1 verify 1

if [ $RUN_NIGHTLY -eq 1 ]; then
	$fio_py iscsi 4096 1 write 300 verify 1
