...
# In case the fuzz tester fails for a timeout or some other reason, we want to clean up still.
$rootdir/test/app/fuzz/nvme_fuzz -t 5 -c $testdir/nvmf_fuzz.conf -n -a || true
