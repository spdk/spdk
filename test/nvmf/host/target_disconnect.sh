...
$rootdir/examples/nvme/perf/perf -q 32 -o 4096 -w randrw -M 50 -t 600 -r "trtype:$TEST_TRANSPORT adrfam:IPv4 traddr:$NVMF_FIRST_TARGET_IP trsvcid:$NVMF_PORT" || true &
perfpid=$!
