...
run_app_bg "$SPDK_EXAMPLE_DIR/bdevperf" -z -r $bdevperf_rpc_sock -q 128 -o 4096 -w verify -t 15 -f &> $testdir/try.txt
bdevperf_pid=$!
...
run_app_bg "$SPDK_EXAMPLE_DIR/bdevperf" -z -r $bdevperf_rpc_sock -q 128 -o 4096 -w verify -t 1 -f &> $testdir/try.txt
bdevperf_pid=$!
