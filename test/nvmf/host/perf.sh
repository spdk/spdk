...
if [ $RUN_NIGHTLY -eq 1 ]; then
	#Add larger size 128K in nightly test
	$rootdir/examples/nvme/perf/perf -q 128 -s 131072 -w randrw -M 50 -t 1 -r "trtype:RDMA adrfam:IPv4 traddr:$NVMF_FIRST_TARGET_IP trsvcid:4420"
fi
sync
