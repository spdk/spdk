...
if [ -n $bdfs ]; then
	...
	jq -r -S '.[]' <<< $nvme_controller_result > $rootdir/test/nvmf/rpc/get_nvme_controllers_nvmf.nvme
	cp $rootdir/test/nvmf/rpc/get_nvme_controllers_nvmf.test.match $rootdir/test/nvmf/rpc/get_nvme_controllers_nvmf.nvme.match
	sed -i "s/\$(S)/\"$bdev_traddr\"/g" $rootdir/test/nvmf/rpc/get_nvme_controllers_nvmf.nvme.match
	# Test get_nvme_controllers cmd with name Nvme0
	$rootdir/test/app/match/match -v $rootdir/test/nvmf/rpc/get_nvme_controllers_nvmf.nvme.match
	rm -f $rootdir/test/nvmf/rpc/get_nvme_controllers_nvmf.nvme.match
	rm -f $rootdir/test/nvmf/rpc/get_nvme_controllers_nvmf.nvme
