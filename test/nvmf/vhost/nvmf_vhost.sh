...
# start qemu based VM.
$rootdir/test/vhost/common/vm_setup.sh -x --os="$vm_image" --disk-type=spdk_vhost_scsi --disks="$vhost_scsi_path"  --force=3

$rootdir/test/vhost/common/vm_run.sh -x 3

vm_wait_for_boot 300 3

vm_start_fio_server 3
...
$rootdir/test/vhost/common/vm_shutdown.sh 3
nvmfcleanup
killprocess $nvmfpid
