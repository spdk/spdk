...
# 1 NVMe-OF subsystem per nvme bdev / lvol store / 40 lvol bdevs
...
$testdir/../fio/nvmf_fio.py 131072 64 randrw 5 verify
$testdir/../fio/nvmf_fio.py 262144 16 randwrite 10 verify
sync
