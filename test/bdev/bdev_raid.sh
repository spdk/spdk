...
function configure_raid_bdev() {
	...
	echo construct_malloc_bdev 32 4096 -b Base_1 >> $testdir/rpcs.txt
	echo construct_malloc_bdev 32 4096 -b Base_2 >> $testdir/rpcs.txt
	echo construct_raid_bdev -z 64 -r 0 -b Base_1 -b Base_2 -n raid0 >> $testdir/rpcs.txt
