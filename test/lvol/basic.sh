...
function test_construct_lvs() {
	...
	rpc_cmd_negative bdev_lvol_create_lvstore NotMalloc lvs_test
	...
	rpc_cmd_negative bdev_lvol_create_lvstore "$malloc_name" lvs_test2

	# remove the lvs and verify it's gone
	rpc_cmd bdev_lvol_delete_lvstore -u "$lvs_uuid"
	rpc_cmd_negative bdev_lvol_get_lvstores -u "$lvs_uuid"
...
function test_construct_lvol() {
	...
	rpc_cmd_negative bdev_get_bdevs -b "$lvol_uuid"
...
function test_construct_lvols_conflict_alias() {
	...
	rpc_cmd_negative bdev_lvol_get_lvstores -u "$lvs1_uuid"
	rpc_cmd bdev_lvol_delete_lvstore -u "$lvs2_uuid"
	rpc_cmd_negative bdev_lvol_get_lvstores -u "$lvs2_uuid"
	rpc_cmd bdev_malloc_delete "$malloc1_name"
	rpc_cmd_negative bdev_get_bdevs -b "$malloc1_name"
...
function test_construct_lvol_inexistent_lvs() {
	...
	rpc_cmd_negative bdev_lvol_create -u "$dummy_uuid" lvol_test "$LVS_DEFAULT_CAPACITY_MB"
...
function test_construct_lvol_full_lvs() {
	...
	rpc_cmd_negative bdev_lvol_create -l lvs_test lvol_test2 1
...
function test_construct_lvol_alias_conflict() {
	...
	rpc_cmd_negative bdev_lvol_create -l lvs_test lvol_test "$lvol_size_mb"

	# clean up
	rpc_cmd bdev_lvol_delete_lvstore -u "$lvs_uuid"
	rpc_cmd_negative bdev_lvol_get_lvstores -u "$lvs_uuid"
	rpc_cmd bdev_malloc_delete "$malloc_name"
	rpc_cmd_negative bdev_get_bdevs -b "$malloc_name"
	check_leftover_devices
}
