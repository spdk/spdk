...
class TestCases(object):
	...
	fail_count = 0
        ...
        if ret_value == 0:
            print("ERROR: Decouple parent on bdev without parent should fail")
            fail_count += 1
    ...
    def test_case759(self):
        ...
        fail_count += self.run_fio_test(nbd_name, begin_fill * MEGABYTE,
                                        end_fill * MEGABYTE - 1, "write", "0xdd", 0)
        ...
        start_fill = int(size * 1 / 5)
        fail_count += self.run_fio_test(nbd_name, start_fill * MEGABYTE,
                                        fill_range * MEGABYTE - 1, "write", "0xee", 0)
