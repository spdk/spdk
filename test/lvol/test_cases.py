...
class TestCases(object):
    ...
    def test_case255(self):
        ...
        self.c.construct_aio_bdev(aio_bdev0, base_name, 1024)
        uuid_store = self.c.construct_lvol_store(base_name,
                                                 self.lvs_name)
        fail_count = self.c.check_get_lvol_stores(base_name, uuid_store,
                                                  self.cluster_size)
    ...
    def test_case700(self):
        ...
        size = self.get_lvol_bdev_split_size(10)
    ...
    def test_case702(self):
        ...
        size_1M = self.get_lvol_bdev_split_size(5, self.lvs_name + "_1M")
        size_32M = self.get_lvol_bdev_split_size(5, self.lvs_name + "_32M")
