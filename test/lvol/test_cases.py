...
class TestCases(object):
    ...
    def test_case650(self):
        ...
        self.c.construct_lvol_bdev(uuid_store, self.lbd_name, free_clusters_start, thin=True)

        lvs = self.c.get_lvol_store_with_name(self.lvs_name)
        free_clusters_create_lvol = int(lvs[u'free_clusters'])
        if free_clusters_start != free_clusters_create_lvol:
            fail_count += 1
        lvol_bdev = self.c.get_lvol_bdev_with_name(self.lvs_name + "/" + self.lbd_name)
        nbd_name = "/dev/nbd0"
    ...
    def test_case651(self):
        ...
        self.c.construct_lvol_bdev(uuid_store, lbd_name0, free_clusters_start, thin=False)
        self.c.construct_lvol_bdev(uuid_store, lbd_name1, free_clusters_start, thin=True)

        lvs = self.c.get_lvol_stores()
        free_clusters_create_lvol = int(lvs['free_clusters'])
        if free_clusters_start != free_clusters_create_lvol:
            fail_count += 1
        lvol_bdev0 = self.c.get_lvol_bdev_with_name(self.lvs_name + "/" + lbd_name0)
        lvol_bdev1 = self.c.get_lvol_bdev_with_name(self.lvs_name + "/" + lbd_name1)
    ...
    def test_case653(self):
        ...
        self.c.construct_lvol_bdev(uuid_store, self.lbd_name, lvol_size, thin=True)
    ...
    def test_case654(self):
        ...
        lbd_name0 = self.lbd_name + str("0")
        lbd_name1 = self.lbd_name + str("1")
        self.c.construct_lvol_bdev(uuid_store, lbd_name0, free_clusters_start, thin=True)
        self.c.construct_lvol_bdev(uuid_store, lbd_name1, free_clusters_start, thin=True)
    ...
    def test_case655(self):
        ...
        self.c.construct_lvol_bdev(uuid_store, lbd_name0, bdev_size, thin=True)
        self.c.construct_lvol_bdev(uuid_store, lbd_name1, bdev_size, thin=True)
