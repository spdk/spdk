...
class TestCases(object):
    ...
    def test_case757(self):
        ...
        for i in range(0, cluster_number - 1):
            if i % 2 == 0:
                start_fill = i * MEGABYTE
                end_fill = (i + 1) * MEGABYTE - 1
                fail_count += self.run_fio_test(nbd_name, start_fill,
                                                end_fill, "write", "0xdd", 0)
        self.c.stop_nbd_disk(nbd_name)
        ...
        for i in range(0, cluster_number - 1):
            ...
            if i % 2 == 0:
                ...
                pattern = "0xcc"
            fail_count += self.run_fio_test(nbd_name, start_fill, end_fill,
                                            "read", pattern)
        self.c.stop_nbd_disk(nbd_name)
