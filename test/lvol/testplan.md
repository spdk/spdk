...
exist in configuration.
Steps:
- try to call construct_lvol_bdev with lvs_guid which does not exist
...
- create a malloc bdev
- construct_lvol_store on created malloc bdev
- construct_lvol_bdev on correct lvs_guid and size is 
  equal one quarter of size malloc bdev
- check size of the lvol bdev 
- resize_lvol_bdev on correct lvs_guid and size is 
  equal half of size malloc bdev
- check size of the lvol bdev by command RPC : get_bdevs
- resize_lvol_bdev on the correct lvs_guid and size is 
...
- create a malloc bdev
- construct_lvol_store on created malloc bdev
- construct_lvol_bdev on correct lvs_guid and 
  size is equal one quarter of size malloc bdev
- resize_lvol_bdev on correct lvs_guid and size is 
  equal of size malloc bdev + 1MiB,10MiB,100MiB,1000MiB
- destroy_lvol_store
- delete malloc bdev
...
Positive test for destroy a logical volume store.
...
- create a malloc bdev
- construct_lvol_store on created malloc bdev
- construct_lvol_bdev on correct lvs_guid and size is equal 
  one quarter of size malloc bdev
- destroy_lvol_store 
- delete malloc bdev

Positive test for destroy singe lvol store with a multi logical volumes.
...
####  destroy_lvol_store_nonexistent_lvs_guid
Call destroy_lvol_store with nonexistent logical_volumes name 
exist in configuration.
Steps:
- try to call destroy_lvol_store with lvs_guid which does not exist
