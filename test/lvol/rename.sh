...
function test_rename_lvs_negative() {
	...
	! rpc_cmd bdev_lvol_rename_lvstore NOTEXIST WHATEVER
	...
	! rpc_cmd bdev_lvol_rename_lvstore lvs_test1 lvs_test2
...
function test_lvol_rename_negative() {
	...
	! rpc_cmd bdev_lvol_rename NOTEXIST WHATEVER
	...
	! rpc_cmd bdev_lvol_rename lvol_test1 lvol_test2
...
run_lvol_test test_rename_positive
run_lvol_test test_rename_lvs_negative
run_lvol_test test_lvol_rename_negative
