...
- rename lvol store; verify that lvol store human friendly name was
  updated in get_lvol_stores output; verify that prefix in lvol bdevs
  human friendly name were also updated
...
- rename lvol bdevs; use lvols human friendly name to point which lvol bdev
