...
- construct_first_nested_lvol_store on created lvol_bdev
- check correct uuid values in response get_lvol_stores command
- construct_first_nested_lvol_bdev on correct lvs_uuid and size is
  equal of size lvol store
- construct_second_nested_lvol_bdev on correct lvs_uuid and size is
  equal of size lvol store
