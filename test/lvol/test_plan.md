...
- use rpc start_nbd_disk/stop_nbd_disk when accessing bdev or snapshot
- try to perform write operation on created snapshot
- check if write failed
- destroy snapshot using rpc delete_bdev
- destroy lvol bdev
- destroy lvol store
- destroy malloc bdev
...
- check if operations end with success
- destroy lvol bdevs
- destroy lvol store
- destroy malloc bdev
...
#### TEST CASE 803 - Name: snapshot_removal
- construct malloc bdev
- construct lvol store on malloc bdev
...
#### TEST CASE 804 - Name: snapshot_of_snapshot
- construct malloc bdev
- construct lvol store on malloc bdev
- construct thick provisioned lvol bdev
- create snapshot of created lvol bdev and check that it is readonly
...
#### TEST CASE 805 - Name: clone_bdev_only
- construct malloc bdev
...
#### TEST CASE 806 - Name: clone_on_the_same_lvs
- construct malloc bdev
- construct lvol store on malloc bdev
- construct thick provisioned lvol bdev
- create snapshot of created lvol bdev
...
#### TEST CASE 807 - Name: clone_and_remove_snapshot
...
#### TEST CASE 808 - Name: clone_writing_to_clone
- construct with malloc bdev
- construct lvol store on malloc bdev
- construct thick provisioned lvol bdev
- fill lvol bdev with 100% of its space
