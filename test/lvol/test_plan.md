...
#### TEST CASE 805 - Name: clone_and_remove_snapshot
...
- fill first clone with 50% of its size
- remove snapshot
- check if data written to first clone after cloning operation
  are available
- check if data on two clones unchanged after cloning operation
  are destroyed
- destroy lvol bdevs
- destroy lvol store
- destroy malloc bdev
