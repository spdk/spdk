...
case $param in
	...
	if [ ! -f "/home/sys_sgsw/vhost_vm_image_mq.qcow2" ]; then
        ...
        echo 'vhost_reactor_mask=0x1' > ./fiotest/autotest.config
	echo 'vhost_master_core=0' >> ./fiotest/autotest.config
	echo '' >> ./fiotest/autotest.config
	echo 'VM_0_qemu_mask=0x6' >> ./fiotest/autotest.config
        echo 'VM_0_qemu_numa_node=0' >> ./fiotest/autotest.config
	./fiotest/autotest.sh --fio-bin=/home/sys_sgsw/fio_ubuntu \
