...
declare -r SPDK_COMMON_DIR=$(readlink -f $(dirname ${BASH_SOURCE[0]}))
# Default running dir -> spdk/..
declare -r SPDK_BUILD_DIR="$(readlink -f $SPDK_COMMON_DIR/../../../)"
declare -r SPDK_VHOST_DEFAULT_TEST_DIR=$(readlink -f $SPDK_BUILD_DIR/..)
