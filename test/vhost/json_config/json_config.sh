...
function upload_vhost() {
    ...
    $rpc_py get_interfaces
    #$rpc_py add_ip_address 127.0.0.1
    $rpc_py set_log_level info
    $rpc_py set_log_print_level info
    $rpc_py set_trace_flag debug
...
function upload_iscsi() {
    ...
    $rpc_py construct_target_node Target1 Target1_alias 'MyBdev:0' '1:1' 64 -g 1
    $rpc_py add_portal_group 2 $TARGET_IP:$ISCSI_PORT2
    $rpc_py add_initiator_group 2 ANY $INITIATOR_IP/32
    ...
    $rpc_py construct_target_node Target10 Target10_alias 'Ceph0:0' '1:2' 64 -d
    $rpc_py get_bdevs
}
