...
function config_base() {
	...
	echo "  Split HotInNvme0n1 2">>$BASE_DIR/vhost.conf.in
	echo "  Split HotInNvme1n1 2">>$BASE_DIR/vhost.conf.in
	echo "  Split HotInNvme2n1 2">>$BASE_DIR/vhost.conf.in
	echo "  Split HotInNvme3n1 2">>$BASE_DIR/vhost.conf.in
}
