...
function scsi_hotremove_tc2() {
    ...
    $rpc_py add_vhost_scsi_lun naa.Nvme0n1p1.0 0 Malloc0
...
function scsi_hotremove_tc3() {
    ...
    $rpc_py add_vhost_scsi_lun naa.Nvme0n1p3.1 0 Malloc1
    vms_setup_and_run_with_arg "0 1"
    vms_prepare "0 1"
    disks=""
    get_disks "0" disks
...
function scsi_hotremove_tc4() {
    ...
    $rpc_py remove_vhost_scsi_dev naa.Nvme0n1p2.1 0
    ...
    bind_nvme "$traddr"
    sleep 1
    $rpc_py remove_vhost_scsi_dev naa.Nvme0n1p1.0 0
    $rpc_py remove_vhost_scsi_dev naa.Nvme0n1p3.1 0
}
