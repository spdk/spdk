...
function blk_test_case2() {
    ...
    $rpc_py construct_vhost_blk_controller naa.Nvme0n1p0.0 ${hot}Nvme0n1p0
    vms_start $single_vm
    # unbind ${hot}Nvme disk and check retcode
    set +e
    ...
    # unbind NVMEe disk and check retcode$
    unbind_bdev $bdf
    sleep 1
...
function blk_test_case3() {
    ...
    if [ -z $hot ]; then
        ...
        $rpc_py construct_vhost_blk_controller naa.Nvme0n1p0.0 ${hot}Nvme1n1p0
        $rpc_py construct_vhost_blk_controller naa.Nvme1n1p0.1 Nvme1n1p0
...
function blk_test_case4() {
    ...
    if [ -z $hot ]; then
        ...
        $rpc_py construct_vhost_blk_controller naa.Nvme0n1p0.0 ${hot}Nvme2n1p0
        $rpc_py construct_vhost_blk_controller naa.Nvme1n1p1.1 ${hot}Nvme2n1p1
        $rpc_py construct_vhost_blk_controller naa.Nvme0n1p1.1 Nvme1n1p0
        $rpc_py construct_vhost_blk_controller naa.Nvme1n1p1.0 Nvme1n1p1
    fi
...
function blk_test_case5() {
    ...
    if [ -z $hot ]; then
        ...
        $rpc_py construct_vhost_blk_controller naa.Nvme0n1p0.0 ${hot}Nvme2n1p0
        $rpc_py construct_vhost_blk_controller naa.Nvme1n1p0.1 ${hot}Nvme3n1p0
    fi
