...
function blk_hotremove_tc2() {
    ...
    #new_disks=""
    #get_blk_disks "0" new_disks
    #check_disks "$disks" "$new_disks"
    #vm_kill "0 1"
    vm_shutdown_all || true
...
function blk_hotremove_tc4() {
    ...
    #disks_vm0=""
    #get_blk_disks "0" disks_vm0
    prepare_fio_cmd_tc1 "0"
    $run_fio &
    last_pid_vm0=$!

    #disks_vm1=""
    #get_blk_disks "1" disks_vm1
    ...
    #new_disks_vm0=""
    #get_blk_disks "0" new_disks_vm0
    #check_disks "$disks_vm0" "$new_disks_vm0"
    #new_disks_vm1=""
    #get_blk_disks "0" new_disks_vm1
