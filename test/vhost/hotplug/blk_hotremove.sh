...
function blk_hotremove_tc2() {
    ...
    $rpc_py construct_vhost_blk_controller naa.Nvme0n1p0.0 HotInNvme4n1p0
...
function blk_hotremove_tc3() {
    ...
    $rpc_py get_bdevs
    $rpc_py construct_vhost_blk_controller naa.Nvme0n1p0.0 HotInNvme5n1p0
    $rpc_py construct_vhost_blk_controller naa.Nvme0n1p1.0 Malloc0
    $rpc_py construct_vhost_blk_controller naa.Nvme0n1p2.1 HotInNvme5n1p1
...
function blk_hotremove_tc4() {
    ...
    $rpc_py get_bdevs
    $rpc_py construct_vhost_blk_controller naa.Nvme0n1p0.0 HotInNvme6n1p0
    $rpc_py construct_vhost_blk_controller naa.Nvme0n1p1.0 Malloc0
    $rpc_py construct_vhost_blk_controller naa.Nvme0n1p2.1 HotInNvme6n1p1
    $rpc_py construct_vhost_blk_controller naa.Nvme0n1p3.1 Malloc1
    vm_run_with_arg "0 1"
    vms_prepare "0 1"
...
function blk_hotremove_tc5() {
    ...
    $rpc_py get_bdevs
    $rpc_py construct_vhost_blk_controller naa.Nvme0n1p0.0 HotInNvme7n1p0
    $rpc_py construct_vhost_blk_controller naa.Nvme0n1p1.0 Malloc0
    $rpc_py construct_vhost_blk_controller naa.Nvme0n1p2.1 Malloc1
    $rpc_py construct_vhost_blk_controller naa.Nvme0n1p3.1 Malloc2
    vm_run_with_arg "0 1"
