...
$rootdir/test/bdev/bdevperf/bdevperf -g -q 128 -o 4096 -w verify -z -t 15 -r /var/tmp/spdk1.sock &
bdevperf_pid1=$!
...
$rootdir/test/bdev/bdevperf/bdevperf -g -q 128 -o 4096 -w verify -z -t 15 -r /var/tmp/spdk2.sock &
bdevperf_pid2=$!
