...
function blk_test_case3() {
    ...
    run_vhost
    $SPDK_BUILD_DIR/scripts/rpc.py construct_vhost_blk_controller naa.Nvme0n1p0.0 Nvme0n1p0
    $SPDK_BUILD_DIR/scripts/rpc.py construct_vhost_blk_controller naa.Nvme1n1p0.1 Nvme1n1p0
...
function blk_test_case4() {
    ...
    $SPDK_BUILD_DIR/scripts/rpc.py construct_vhost_blk_controller naa.Nvme1n1p0.1 Nvme1n1p0
    $SPDK_BUILD_DIR/scripts/rpc.py construct_vhost_blk_controller naa.Nvme1n1p1.0 Nvme1n1p1
