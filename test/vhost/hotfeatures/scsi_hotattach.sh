...
no_shutdown=false
fio_bin="fio"
fio_jobs="$BASE_DIR/..fiotest/fio_jobs/"
...
cp $BASE_DIR/../fiotest/autotest.config $BASE_DIR/../fiotest/autotest.config.old
cp $BASE_DIR/autotest.config $BASE_DIR/../fiotest/autotest.config
...
cp $BASE_DIR/../fiotest/vhost.conf.in $BASE_DIR/../fiotest/vhost.conf.in.old
$SPDK_BUILD_DIR/scripts/gen_nvme.sh >> $BASE_DIR/../fiotest/vhost.conf.in

echo "[Split]" >> $BASE_DIR/../fiotest/vhost.conf.in
echo "  Split Nvme0n1 4" >> $BASE_DIR/../fiotest/vhost.conf.in

echo "[VhostScsi0]" >> $BASE_DIR/../fiotest/vhost.conf.in
echo "  Name naa.Nvme0n1p0.0" >> $BASE_DIR/../fiotest/vhost.conf.in
echo "[VhostScsi1]" >> $BASE_DIR/../fiotest/vhost.conf.in
echo "  Name naa.Nvme0n1p1.0" >> $BASE_DIR/../fiotest/vhost.conf.in
echo "[VhostScsi2]" >> $BASE_DIR/../fiotest/vhost.conf.in
echo "  Name naa.Nvme0n1p2.1" >> $BASE_DIR/../fiotest/vhost.conf.in
echo "[VhostScsi3]" >> $BASE_DIR/../fiotest/vhost.conf.in
echo "  Name naa.Nvme0n1p3.1" >> $BASE_DIR/../fiotest/vhost.conf.in
...
cp $BASE_DIR/../fiotest/vhost.conf.in.old $BASE_DIR/../fiotest/vhost.conf.in
rm $BASE_DIR/../fiotest/vhost.conf.in.old
...
cp $BASE_DIR/../fiotest/autotest.config.old $BASE_DIR/../fiotest/autotest.config
rm $BASE_DIR/../fiotest/autotest.config.old
