...
$SPDK_BUILD_DIR/app/nvmf_tgt/nvmf_tgt -s 512 -m 0x2 -c $TEST_DIR/nvmf.conf -r $TEST_DIR/rpc_nvmf.sock &
nvmf_tgt_pid=$!
...
if $use_virtio; then
	...
	run_spdk_fio_virtio $fio_jobs --filename=$virtio_bdevs --spdk_conf=$BASE_DIR/bdev.conf
