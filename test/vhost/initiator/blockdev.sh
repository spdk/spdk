...
function start_and_prepare_vm() {
	...
	os="/home/sys_sgsw/fedora-25.qcow2"
	...
	vm_scp $vm_num -r "/usr/src/fio" "127.0.0.1:/usr/src/"
}
...
function run_guest_fio() {
	...
	fio_job="$testdir/bdev.fio"
        conf_file="$testdir/bdevvm.conf"
	run_fio="LD_PRELOAD=/root/spdk/examples/bdev/fio_plugin/fio_plugin /usr/src/fio/fio --ioengine=spdk_bdev"
