...
Negative test case for creating pmem pool file with total size and block size
negative value arguments.
Steps & expected results:
- call create_pmem_pool with correct path argument, total size=256MB and
block size=-1
- return code !=0 and error code !=0
- call pmem_pool_info to verify pmem pool file was not created
- call create_pmem_pool with correct path argument, total size=-1 and
block size=512
- return code !=0 and error code !=0
- call pmem_pool_info to verify pmem pool file was not created
- return code = 0
