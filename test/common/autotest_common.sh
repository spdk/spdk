...
#By default most of the tests options are enabled. Setting *_DEFAULT=0 will disable tests by default.
TEST_DEFAULT="${SPDK_TEST_DEFAULT:-1}"
RUN_DEFAULT="${SPDK_RUN_DEFAULT:-1}"
BUILD_DEFAULT="${SPDK_BUILD_DEFAULT:-1}"
# Set defaults for missing test config options
: ${SPDK_BUILD_DOC=$BUILD_DEFAULT}; export SPDK_BUILD_DOC
: ${SPDK_BUILD_SHARED_OBJECT=$BUILD_DEFAULT}; export SPDK_BUILD_SHARED_OBJECT
: ${SPDK_RUN_CHECK_FORMAT=$RUN_DEFAULT}; export SPDK_RUN_CHECK_FORMAT
: ${SPDK_RUN_SCANBUILD=$RUN_DEFAULT}; export SPDK_RUN_SCANBUILD
: ${SPDK_RUN_VALGRIND=$RUN_DEFAULT}; export SPDK_RUN_VALGRIND
: ${SPDK_RUN_FUNCTIONAL_TEST=1}; export SPDK_RUN_FUNCTIONAL_TEST
: ${SPDK_TEST_UNITTEST=$TEST_DEFAULT}; export SPDK_TEST_UNITTEST
: ${SPDK_TEST_ISAL=$TEST_DEFAULT}; export SPDK_TEST_ISAL
: ${SPDK_TEST_ISCSI=$TEST_DEFAULT}; export SPDK_TEST_ISCSI
: ${SPDK_TEST_ISCSI_INITIATOR=$TEST_DEFAULT}; export SPDK_TEST_ISCSI_INITIATOR
: ${SPDK_TEST_NVME=$TEST_DEFAULT}; export SPDK_TEST_NVME
: ${SPDK_TEST_NVME_CLI=$TEST_DEFAULT}; export SPDK_TEST_NVME_CLI
: ${SPDK_TEST_NVMF=$TEST_DEFAULT}; export SPDK_TEST_NVMF
: ${SPDK_TEST_RBD=$TEST_DEFAULT}; export SPDK_TEST_RBD
: ${SPDK_TEST_VHOST=$TEST_DEFAULT}; export SPDK_TEST_VHOST
: ${SPDK_TEST_BLOCKDEV=$TEST_DEFAULT}; export SPDK_TEST_BLOCKDEV
: ${SPDK_TEST_IOAT=$TEST_DEFAULT}; export SPDK_TEST_IOAT
: ${SPDK_TEST_EVENT=$TEST_DEFAULT}; export SPDK_TEST_EVENT
: ${SPDK_TEST_BLOBFS=$TEST_DEFAULT}; export SPDK_TEST_BLOBFS
: ${SPDK_TEST_VHOST_INIT=$TEST_DEFAULT}; export SPDK_TEST_VHOST_INIT
: ${SPDK_TEST_PMDK=$TEST_DEFAULT}; export SPDK_TEST_PMDK
: ${SPDK_TEST_LVOL=$TEST_DEFAULT}; export SPDK_TEST_LVOL
: ${SPDK_TEST_JSON=$TEST_DEFAULT}; export SPDK_TEST_JSON
: ${SPDK_TEST_REDUCE=$TEST_DEFAULT}; export SPDK_TEST_REDUCE
: ${SPDK_RUN_ASAN=$RUN_DEFAULT}; export SPDK_RUN_ASAN
: ${SPDK_RUN_UBSAN=$RUN_DEFAULT}; export SPDK_RUN_UBSAN
: ${SPDK_RUN_INSTALLED_DPDK=$RUN_DEFAULT}; export SPDK_RUN_INSTALLED_DPDK
: ${SPDK_TEST_CRYPTO=$TEST_DEFAULT}; export SPDK_TEST_CRYPTO
: ${SPDK_TEST_FTL=0}; export SPDK_TEST_FTL
: ${SPDK_TEST_BDEV_FTL=0}; export SPDK_TEST_BDEV_FTL
: ${SPDK_TEST_OCF=$TEST_DEFAULT}; export SPDK_TEST_OCF
