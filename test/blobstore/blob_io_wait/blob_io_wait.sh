...
$rootdir/test/bdev/bdevperf/bdevperf -c $testdir/bdevperf.conf -q 128 -o 4096 -w write -t 5 --wait-for-rpc
$rpc_py bdev_histogram_enable aio0
$rpc_py start_subsystem_init
$rpc_py bdev_histogram_get aio0

$rootdir/test/bdev/bdevperf/bdevperf -c $testdir/bdevperf.conf -q 128 -o 4096 -w read -t 5 --wait-for-rpc
$rpc_py bdev_histogram_enable aio0
$rpc_py start_subsystem_init
sleep 1
$rpc_py bdev_histogram_get aio0
$rpc_py bdev_histogram_disable aio0
