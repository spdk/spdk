...
if $RUN_AUTOTEST; then
	...
	vagrant ssh -c "cp spdk_repo/spdk/test/vagrant/autorun-spdk.conf /home/vagrant/"
	vagrant ssh -c "mkdir /home/vagrant/output"
	vagrant ssh -c "./spdk_repo/spdk/autorun.sh;"
