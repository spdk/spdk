...
if $RUN_AUTOTEST; then
	...
	vagrant ssh -c "cd /home/vagrant/spdk_repo/spdk; git clean -df; git submodule update --init --recursive"
	...
	vagrant ssh -c "cd /home/vagrant/spdk_repo/spdk; git submodule update --init --recursive; ./configure; make clean; make -j$VM_CORES"
