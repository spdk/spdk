...
[[ $2 != "" ]] && size=$((1024 * $2))
[[ $3 != "" ]] && mask=$3
[[ $4 != "" ]] && [[ $4 -gt 1 && $4 -le 16 ]] && nbufs=$4
[[ $5 != "" ]] && [[ $5 -gt 0 && $5 -lt 4096 ]] && queue=$5
[[ $6 != "" ]] && option=$6

echo "XOR with $module (block $size, core_mask $mask, nbufs $nbufs, queue $queue $option)..."
...
if [ $module != "software" ]; then
	...
	$rootdir/scripts/rpc.py accel_assign_opc -o xor -m accel_$module
