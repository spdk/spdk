...
def get_bdev_name_key(bdev):
    ...
    if 'method' in bdev and bdev['method'] == 'construct_crypto_bdev':
        bdev_name_key = "crypto_bdev_name"
...
def get_bdev_name(bdev):
    ...
    if 'params' in bdev:
        ...
        elif 'crypto_bdev_name' in bdev['params']:
            bdev_name = bdev['params']['crypto_bdev_name']
