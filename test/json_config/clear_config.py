...
def clear_subsystem_rpc(client, args):
...
if __name__ == "__main__":
    ...
    def clear_config(args):
        clear_config_rpc(args.client, args)
    ...
    def clear_subsystem(args):
        clear_subsystem_rpc(args.client, args)
