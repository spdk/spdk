...
# 1. Save a list of bdevs and save it to the file "base_bdevs".
...
# 3. Start the spdk_tgt and it waits for loading global parameters.
# 4. Save config to the file "full_config".
# 5. Save only global parameters to the file "last_json_config".
# 6. Check if the file "base_json_config" matches the file "last_json_config".
# 7. Delete all files.
