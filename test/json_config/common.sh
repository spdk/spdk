...
function test_json_config() {
	...
	$JSON_DIR/config_parser.py -method "skip_params" -filename $full_config > $base_json_config
	$clear_config_py clear_config
	$rpc_py save_config -f $tmp_config
	$JSON_DIR/config_parser.py -method "skip_params" -filename $tmp_config > $skip_params_config
	...
	$rpc_py save_config -f $tmp_config
	$JSON_DIR/config_parser.py -method "skip_params" -filename $tmp_config > $last_json_config
...
function create_bdev_subsystem_config() {
	...
	$rpc_py construct_lvol_store -c 1048576 Nvme0n1p7 lvs_test
