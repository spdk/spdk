...
function upload_initiator() {
	...
	#$rpc_py construct_virtio_dev -t user -a "0000:00:04.0" -d scsi SampleVirtio
	#$rpc_py construct_virtio_pci_scsi_bdev $JSON_DIR/naa.Nvme1n1p1.1 Nvme1n1p1
	#$rpc_py get_virtio_scsi_devs
	#$rpc_py construct_virtio_pci_blk_bdev $JSON_DIR/naa.Nvme1n1p3.1 Nvme1n1p3
}
