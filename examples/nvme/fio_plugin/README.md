...
but it is not good to use one thread against many I/O devices. So testing FIO on multiple NVMe SSDs with SPDK plugin,
we recommend using multiple jobs in FIO configuration.
