...
def printListInformation(table_type, test_list):
    printList("{} Executed in Build" % table_type, test_list, 0, True)
    printList("{} Missing From Build" % table_type, test_list, 0, False)
    printList("{} Missing ASAN" % table_type, test_list, 1, False)
    printList("{} Missing UBSAN" % table_type, test_list, 2, False)
