...
display_help() {
	...
	echo "  --move-to-def-dir           Move generated files to default directories used by vhost test scripts."
	echo "                              Default: false."
...
while getopts ":xh-:" opt; do
	case "${opt}" in
		...
		case "${OPTARG}" in
			...
			move-to-def-dir) MOVE_TO_DEF_DIR=true ;;
