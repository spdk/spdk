...
def apply_firmware(args):
    ...
    if args.bdev_name:
        params['bdev_name'] = args.bdev_name
...
p.add_argument('-p','--filename', help='filename of the firmware to download', required=True)
p.add_argument('-n', '--bdev_name', help='name of the NVMe device', required=True)
