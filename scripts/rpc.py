...
if __name__ == "__main__":
    ...
    def delete_ocf_bdev(args):
        print_dict(rpc.bdev.delete_ocf_bdev(args.client,
                                            name=args.name))
    p = subparsers.add_parser('delete_ocf_bdev',
                              help='Delete a OCF block device')
    ...
    p = subparsers.add_parser('get_ocf_bdevs',
                              help='Get list of OCF bdevs including unregistered ones')
