...
if __name__ == "__main__":
    ...
    p.add_argument('-b', '--base_bdev_name', help="Name of the existing bdev", required=True)
    p.add_argument('-p', '--passthru_bdev_name', help="Name of the passthru bdev", required=True)
