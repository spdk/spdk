...
if __name__ == "__main__":
    ...
    p = subparsers.add_parser('construct_passthru_bdev',
                              help='Add a pass through virtual bdev on existing bdev')
    p.add_argument('-b', '--bdev_name', help="Name of the existing bdev", required=True)
    p.add_argument('-v', '--vbdev_name', help="Name of the virtual bdev", required=True)
