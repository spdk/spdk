...
if __name__ == "__main__":
    ...
    p.add_argument('-n', '--name', help="Name of the NVMe controller, prefix for each bdev name")
    p.add_argument('--timeout', help="Timeout for the specified command, in microseconds.", type=int)
    p.add_argument('--count', help="Error count for the specified NVMe command.", type=int)
    p.add_argument('--opc', help="NVMe command opcode.", type=int)
    p.add_argument('--sct', help="Status code type.", type=int)
    p.add_argument('--sc', help="Generic command status code.", type=int)
    ...
    p.add_argument('-o', '--opc', help="NVMe command opcode.", type=int)
