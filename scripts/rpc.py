...
Format: 'user:u1 secret:s1 muser:mu1 msecret:ms1,user:u2 secret:s2 muser:mu2 msecret:ms2'""", required=False)
    ...
    *** The Portal/Initiator Groups must be precreated ***""")
    ...
    p.add_argument('-s', '--strip-size', help='strip size in KB (deprecated)', type=int, required=False, default=0)
    p.add_argument('-z', '--strip-size_kb', help='strip size in KB', type=int, required=False, default=0)
