...
if __name__ == "__main__":
    ...
    p.add_argument('--disable', dest='enable', default=False, action='store_false', help="Disable hotplug (default)")
    p.add_argument('--enable', action='store_true', help="Enable hotplug")
