...
def parser_bdev_lvol_name(subparsers):
...
# parser_error_bdev_inject_error = parser_bdev_error_inject
...
# parser_tenable_tpoint_group = parser_trace_enable_tpoint_group
