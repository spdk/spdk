...
if __name__ == "__main__":
    ...
    p.add_argument('--rw_ios_per_sec',
                   help='R/W IOs per second limit (>=10000, example: 20000). -1 means unlimited.',
                   type=int, required=False)
    p.add_argument('--r_ios_per_sec',
                   help='Read IOs per second limit (>=10000, example: 20000). -1 means unlimited.',
                   type=int, required=False)
    p.add_argument('--w_ios_per_sec',
                   help='Write IOs per second limit (>=10000, example: 20000). -1 means unlimited.',
                   type=int, required=False)
    p.add_argument('--rw_mbytes_per_sec',
                   help="R/W megabytes per second limit (>=10, example: 100). -1 means unlimited.",
                   type=int, required=False)
    p.add_argument('--r_mbytes_per_sec',
                   help="Read megabytes per second limit (>=10, example: 100). -1 means unlimited.",
                   type=int, required=False)
    p.add_argument('--w_mbytes_per_sec',
                   help="Write megabytes per second limit (>=10, example: 100). -1 means unlimited.",
                   type=int, required=False)
