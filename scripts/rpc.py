...
Format: 'user:u1 secret:s1 muser:mu1 msecret:ms1,user:u2 secret:s2 muser:mu2 msecret:ms2'""", required=False)
    ...
    *** Mutually exclusive with --disable-chap ***""", action='store_true')
    ...
    p.add_argument('-b', '--nvme_ctrlr_name', help='nvme ctrlr name')
    ...
    p.add_argument('-b', '--nvme_ctrlr_name', help='nvme ctrlr name')
    p.add_argument('-n', '--nsid', help='namespace ID (only support nsid=1 for now)', type=int)
    ...
    p.add_argument('-l', '--range_length', help='locking range length (in blocks)', type=int)
    p.add_argument('-p', '--password', help='admin password')
    p.add_argument('-o', '--bdev_name', help='name for this new bdev')
