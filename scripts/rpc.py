...
if __name__ == "__main__":
    ...
    *** The Portal/Initiator Groups must be precreated ***""")
    ...
    p = subparsers.add_parser('get_pvols', help='Get pooled device information')
    ...
    p.add_argument('-s', '--strip_size', help='strip size', type=int, required=True)
    p.add_argument('-r', '--raid_level', help='raid level, only raid level 0 is supported', type=int, required=True)
