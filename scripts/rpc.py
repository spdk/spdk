...
def construct_lvol_store(args):
    ...
    if args.disable_trim:
        params['disable_trim'] = args.disable_trim
...
p.add_argument('-d', '--disable_trim', help='disable data clusters trimming [y/n] (default = no)', required=False)
