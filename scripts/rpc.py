...
if __name__ == "__main__":
    ...
    *** The Portal/Initiator Groups must be precreated ***""")
    ...
    def set_trace_flag(args):
        rpc.log.set_trace_flag(args.client, args.flag)
    ...
    def clear_trace_flag(args):
        rpc.log.clear_trace_flag(args.client, args.flag)
    ...
    def set_log_level(args):
        rpc.log.set_log_level(args.client, args.level)
    ...
    def set_log_print_level(args):
        rpc.log.set_log_print_level(args.client, args.level)
    ...
    def add_ip_address(args):
        rpc.net.add_ip_address(args.client, args.ifc_index, args.ip_addr)
    ...
    def delete_ip_address(args):
        rpc.net.delete_ip_address(args.client, args.ifc_index, args.ip_addr)
