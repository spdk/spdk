...
if __name__ == "__main__":
    ...
    def bdev_histogram(args):
        rpc.bdev.bdev_histogram(args.client, name=args.name, enable=args.enable)

    p = subparsers.add_parser('bdev_histogram', help='Enable or disable histogram for specified bdev')
    ...
    p.set_defaults(func=bdev_histogram)
