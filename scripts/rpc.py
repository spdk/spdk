...
if __name__ == "__main__":
    ...
    @subcommand
    def framework_monitor_context_switch(p):
    ...
    @subcommand
    def bdev_compress_get_orphans(p):
    ...
    @subcommand
    def bdev_nvme_attach_controller(p):
    ...
    @subcommand
    def bdev_nvme_get_controllers(p):
    ...
    @subcommand
    def bdev_nvme_detach_controller(p):
    ...
    @subcommand
    def bdev_nvme_cuse_unregister(p):
    ...
    @subcommand
    def bdev_delay_update_latency(p):
    ...
    @subcommand
    def bdev_set_qd_sampling_period(p):
    ...
    @subcommand
    def bdev_nvme_apply_firmware(p):
    ...
    @subcommand
    def iscsi_set_discovery_auth(p):
    ...
    @subcommand
    def iscsi_auth_group_add_secret(p):
    ...
    @subcommand
    def iscsi_auth_group_remove_secret(p):
    ...
    @subcommand
    def iscsi_get_initiator_groups(p):
    ...
    @subcommand
    def iscsi_create_target_node(p):
    ...
    @subcommand
    def iscsi_target_node_add_lun(p):
    ...
    @subcommand
    def iscsi_target_node_set_auth(p):
    ...
    @subcommand
    def iscsi_target_node_add_pg_ig_maps(p):
    ...
    @subcommand
    def iscsi_target_node_remove_pg_ig_maps(p):
    ...
    @subcommand
    def iscsi_create_portal_group(p):
    ...
    @subcommand
    def iscsi_create_initiator_group(p):
    ...
    @subcommand
    def iscsi_initiator_group_add_initiators(p):
    ...
    @subcommand
    def iscsi_initiator_group_remove_initiators(p):
    ...
    @subcommand
    def iscsi_delete_target_node(p):
    ...
    @subcommand
    def iscsi_delete_portal_group(p):
    ...
    @subcommand
    def iscsi_delete_initiator_group(p):
    ...
    @subcommand
    def iscsi_portal_group_set_auth(p):
    ...
    @subcommand
    def trace_enable_tpoint_group(p):
    ...
    @subcommand
    def trace_disable_tpoint_group(p):
    ...
    @subcommand
    def trace_get_tpoint_group_mask(p):
    ...
    @subcommand
    def bdev_lvol_create_lvstore(p):
    ...
    @subcommand
    def bdev_lvol_rename_lvstore(p):
    ...
    @subcommand
    def bdev_lvol_decouple_parent(p):
    ...
    @subcommand
    def bdev_lvol_delete_lvstore(p):
    ...
    @subcommand
    def net_interface_add_ip_address(p):
    ...
    @subcommand
    def net_interface_delete_ip_address(p):
    ...
    @subcommand
    def nvmf_subsystem_add_listener(p):
    ...
    @subcommand
    def nvmf_subsystem_remove_listener(p):
    ...
    @subcommand
    def nvmf_subsystem_remove_ns(p):
    ...
    @subcommand
    def nvmf_subsystem_remove_host(p):
    ...
    @subcommand
    def nvmf_subsystem_allow_any_host(p):
    ...
    @subcommand
    def framework_get_subsystems(p):
    ...
    @subcommand
    def vhost_controller_set_coalescing(p):
    ...
    @subcommand
    def vhost_create_scsi_controller(p):
    ...
    @subcommand
    def vhost_scsi_controller_add_target(p):
    ...
    @subcommand
    def vhost_scsi_controller_remove_target(p):
    ...
    @subcommand
    def vhost_create_blk_controller(p):
    ...
    @subcommand
    def vhost_create_nvme_controller(p):
    ...
    @subcommand
    def vhost_nvme_controller_add_ns(p):
    ...
    @subcommand
    def bdev_virtio_attach_controller(p):
    ...
    @subcommand
    def bdev_virtio_scsi_get_devices(p):
    ...
    @subcommand
    def bdev_virtio_detach_controller(p):
    ...
    @subcommand
    def bdev_opal_set_lock_state(p):
    ...
    @subcommand
    def notify_get_notifications(p):
    ...
    def blobfs_mount(p):
        ...
        p.set_defaults(func=do_do_blobfs_mount)

    @subcommand
    def blobfs_set_cache_size(p):
    ...
    def execute_subcommand(argv):
        ...
        try:
            subcommands[subcommand_name](argv[1:])
