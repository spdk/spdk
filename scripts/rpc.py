...
if __name__ == "__main__":
    ...
    p = subparsers.add_parser('delete_nvme_controller',
                              help='Delete a NVMe controller using transport ID or controller name')
    ...
    *** The devices must pre-exist ***""")
    ...
    This will delete all bdevs exposed by this device (this call is depreciated - please use remove_virtio_bdev call instead).""")
