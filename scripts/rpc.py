...
def construct_gpt_bdev(args):
    params = {'base_name': args.base_name}
    jsonrpc_call('construct_gpt_bdev', params)
p = subparsers.add_parser('construct_gpt_bdev', help='Add bdev with gpt backend')
p.add_argument('base_name', help='base bdev name')
p.set_defaults(func=construct_gpt_bdev)
