...
p = subparsers.add_parser('construct_vhost_block_controller', help='Add new vhost block controller')
p.add_argument('ctrlr', help='controller name')
p.add_argument('--cpumask', help='cpu mask for this controller')
...
p = subparsers.add_parser('remove_vhost_block_controller', help='Remove vhost blokck controller')
p.add_argument('ctrlr', help='controller name')
...
p = subparsers.add_parser('add_vhost_block_dev', help='Add dev to vhost block controller')
p.add_argument('ctrlr', help='conntroller name where add device')
p.add_argument('dev_name', help='vhost block dev_name')
...
p = subparsers.add_parser('remove_vhost_block_dev', help='Remove device from vhost block controller')
p.add_argument('ctrlr', help='controller name to remove device from')
