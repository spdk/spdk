...
if __name__ == "__main__":
    ...
    p = subparsers.add_parser('bdev_uring_create', aliases=['construct_uring_bdev'],
                              help='Add a bdev with uring backend')
    ...
    p = subparsers.add_parser('bdev_uring_delete', aliases=['delete_uring_bdev'],
                              help='Delete a uring disk')
