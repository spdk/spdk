...
def subcommand(rpc_parser):
    def inner(subparsers):
        rpc_parser(subparsers)
    subcommands[rpc_parser.__name__] = inner
    return rpc_parser
...
class PreParser(argparse.ArgumentParser):
    def print_help(self, file=None):
        ...
        super(PreParser, self).print_help(file)

    def print_usage(self, file=None):
        subparsers = self.add_subparsers(help='RPC methods', dest='called_rpc_name')
        add_subparsers(subparsers)
        super(PreParser, self).print_usage(file)
...
if __name__ == "__main__":
    ...
    @subcommand
    def parser_bdev_uring_create(subparsers):
    ...
    @subcommand
    def parser_bdev_uring_delete(subparsers):
    ...
    @subcommand
    def parser_bdev_nvme_cuse_register(subparsers):
    ...
    @subcommand
    def parser_bdev_nvme_cuse_unregister(subparsers):
    ...
    @subcommand
    def parser_bdev_zone_block_create(subparsers):
    ...
    @subcommand
    def parser_bdev_zone_block_delete(subparsers):
    ...
    # opal
    @subcommand
    def parser_bdev_nvme_opal_init(subparsers):
    ...
    @subcommand
    def parser_bdev_nvme_opal_revert(subparsers):
    ...
    @subcommand
    def parser_bdev_opal_create(subparsers):
    ...
    @subcommand
    def parser_bdev_opal_get_info(subparsers):
    ...
    @subcommand
    def parser_bdev_opal_delete(subparsers):
    ...
    @subcommand
    def parser_bdev_opal_new_user(subparsers):
    ...
    @subcommand
    def parser_bdev_opal_set_lock_state(subparsers):
    ...
    @subcommand
    def parser_blobfs_mount(subparsers):
    ...
    @subcommand
    def parser_blobfs_set_cache_size(subparsers):
    ...
    if args.rest:
        if 'parser_' + args.rest[0] in subcommands:
            subcommands['parser_' + args.rest[0]](subparsers)
        elif args.rest[0] in deprecated_aliases:
            subcommands['parser_' + deprecated_aliases[args.rest[0]]](subparsers)
        else:
            # rpc not found
            add_subparsers(subparsers)
    else:
