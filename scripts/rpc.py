...
if __name__ == "__main__":
    ...
    *** The devices must pre-exist ***""")
    ...
    @call_cmd
    def initialize_iscsi_subsystem(args):
        rpc.subsystem.initialize_iscsi_subsystem(args.client, args)

    p = subparsers.add_parser('initialize_iscsi_subsystem', help="""Initialize iSCSI subsystem""")
