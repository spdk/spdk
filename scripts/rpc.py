...
if __name__ == "__main__":
    ...
    def bdev_size_adapter_create(args):
        print_json(rpc.bdev.bdev_size_adapter_create(args.client,
                                                     name=args.name,
                                                     base_bdev=args.base_bdev))

    p = subparsers.add_parser('bdev_size_adapter_create',
    ...
    p.set_defaults(func=bdev_size_adapter_create)

    def bdev_size_adapter_delete(args):
        rpc.bdev.bdev_size_adapter_delete(args.client,
                                          name=args.name)

    p = subparsers.add_parser('bdev_size_adapter_delete',
                              help='Delete a legacy (512B) sector size bdev')
    p.add_argument('name', help='Block size adapter bdev name')
    p.set_defaults(func=bdev_size_adapter_delete)
