...
if __name__ == "__main__":
    ...
    p = subparsers.add_parser('get_rpc_methods',
                              help='Get list of supported RPC methods')
    p.set_defaults(func=rpc.app.get_rpc_methods)
    ...
    p = subparsers.add_parser('context_switch_monitor',
    ...
    p.set_defaults(func=rpc.log.context_switch_monitor)
    ...
    p = subparsers.add_parser('get_interfaces',
    ...
    p.add_argument('total_size',
                   help='Size of malloc bdev in MB (int > 0)', type=int)
    ...
    p.add_argument('-n', '--subnqn',
                   help='NVMe-oF target subnqn')
    ...
    p.add_argument('-n', '--num',
                   help='the number of commands you want to fail', type=int, default=1)
...
# p.set_defaults(func=rpc.lvol.resize_lvol_bdev)
    ...
    p.set_defaults(func=rpc.pmem.construct_pmem_bdev)
