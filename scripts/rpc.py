...
if __name__ == "__main__":
    ...
    *** The devices must pre-exist ***""")
    ...
    @call_cmd
    def nvme_cmd(args):
        print_dict(rpc.nvme.nvme_cmd(args.client,
                                     name=args.nvme_name,
                                     type=args.type,
    ...
    p = subparsers.add_parser('nvme_cmd', help='NVMe passthrough cmd.')
    p.add_argument('-n', '--nvme-name', help="""Name of the operating NVMe devices""")
    p.add_argument('-t', '--type', help="""Type of nvme cmd. Valid values are: admin, io""")
