...
if __name__ == "__main__":
    ...
    @call_cmd
    def set_bdev_qd_tracking_sampling_period(args):
        rpc.bdev.set_bdev_qd_tracking_sampling_period(args.client,
                                                      name=args.name,
                                                      period=args.period)

    p = subparsers.add_parser('set_bdev_qd_tracking_sampling_period', help="Enable or disable tracking of a bdev's queue depth.")
    ...
    p.add_argument('period', help='Period with which to poll the block device queue depth in microseconds.'
                   ...
                   type=int)
    p.set_defaults(func=set_bdev_qd_tracking_sampling_period)
