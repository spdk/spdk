...
class RpcParser(argparse.ArgumentParser):
    def add_global_parsers(self, subparsers):
        for parser in global_parsers:
            eval(parser)(subparsers)

    def print_help(self, file=None):
        subparsers = self.add_subparsers(help='RPC methods', dest='called_rpc_name')
        self.add_global_parsers(subparsers)
        super(RpcParser, self).print_help(file)


def get_parser():
    parser = RpcParser(description='SPDK RPC command line interface')
...
def parser_start_subsystem_init(subparsers):
...
def parser_wait_subsystem_init(subparsers):
...
def parser_rpc_get_methods(subparsers):
...
def parser_spdk_get_version(subparsers):
...
def parser_save_config(subparsers):
...
def parser_load_config(subparsers):
...
def parser_save_subsystem_config(subparsers):
...
def parser_load_subsystem_config(subparsers):
...
# app
def parser_spdk_kill_instance(subparsers):
...
def parser_context_switch_monitor(subparsers):
...
# bdev
def parser_bdev_set_options(subparsers):
...
def parser_bdev_compress_create(subparsers):
...
def parser_bdev_compress_delete(subparsers):
...
def parser_set_compress_pmd(subparsers):
...
def parser_bdev_compress_get_orphans(subparsers):
...
def parser_bdev_crypto_create(subparsers):
...
def parser_bdev_crypto_delete(subparsers):
...
def parser_bdev_ocf_create(subparsers):
...
def parser_bdev_ocf_delete(subparsers):
...
def parser_bdev_ocf_get_stats(subparsers):
...
def parser_bdev_ocf_get_bdevs(subparsers):
...
def parser_bdev_malloc_create(subparsers):
...
def parser_bdev_malloc_delete(subparsers):
...
def parser_bdev_null_create(subparsers):
...
def parser_bdev_null_delete(subparsers):
...
def parser_bdev_aio_create(subparsers):
...
def parser_bdev_aio_delete(subparsers):
...
def parser_bdev_nvme_set_options(subparsers):
...
def parser_bdev_nvme_set_hotplug(subparsers):
...
def parser_bdev_nvme_attach_controller(subparsers):
...
def parser_bdev_nvme_get_controllers(subparsers):
...
def parser_delete_nvme_controller(subparsers):
...
def parser_bdev_rbd_create(subparsers):
...
def parser_bdev_rbd_delete(subparsers):
...
def parser_bdev_delay_create(subparsers):
...
def parser_bdev_delay_delete(subparsers):
...
def parser_bdev_delay_update_latency(subparsers):
...
def parser_bdev_error_create(subparsers):
...
def parser_bdev_error_delete(subparsers):
...
def parser_bdev_iscsi_create(subparsers):
...
def parser_bdev_iscsi_delete(subparsers):
...
def parser_bdev_pmem_create(subparsers):
...
def parser_bdev_pmem_delete(subparsers):
...
def parser_bdev_passthru_create(subparsers):
...
def parser_bdev_passthru_delete(subparsers):
...
def parser_bdev_get_bdevs(subparsers):
...
def parser_bdev_get_iostat(subparsers):
...
def parser_bdev_enable_histogram(subparsers):
...
def parser_bdev_get_histogram(subparsers):
...
def parser_bdev_set_qd_sampling_period(subparsers):
...
def parser_bdev_set_qos_limit(subparsers):
...
def parser_bdev_error_inject_error(subparsers):
...
def parser_bdev_nvme_apply_firmware(subparsers):
...
# iSCSI
def parser_iscsi_set_options(subparsers):
...
def parser_iscsi_set_discovery_auth(subparsers):
...
def parser_iscsi_create_auth_group(subparsers):
...
def parser_iscsi_delete_auth_group(subparsers):
...
def parser_iscsi_auth_group_add_secret(subparsers):
...
def parser_iscsi_auth_group_remove_secret(subparsers):
...
def parser_iscsi_get_auth_groups(subparsers):
...
def parser_iscsi_get_portal_groups(subparsers):
...
def parser_iscsi_get_initiator_groups(subparsers):
...
def parser_iscsi_get_target_nodes(subparsers):
...
def parser_iscsi_create_target_node(subparsers):
...
def parser_iscsi_target_node_add_lun(subparsers):
...
def parser_iscsi_target_node_set_auth(subparsers):
...
def parser_iscsi_target_node_add_pg_ig_maps(subparsers):
...
def parser_iscsi_target_node_remove_pg_ig_maps(subparsers):
...
def parser_iscsi_create_portal_group(subparsers):
...
def parser_iscsi_create_initiator_group(subparsers):
...
def parser_iscsi_initiator_group_add_initiators(subparsers):
...
def parser_iscsi_initiator_group_remove_initiators(subparsers):
...
def parser_iscsi_delete_portal_group(subparsers):
...
def parser_iscsi_delete_initiator_group(subparsers):
...
def parser_iscsi_portal_group_set_auth(subparsers):
...
def parser_iscsi_get_connections(subparsers):
...
def parser_iscsi_get_options(subparsers):
...
# log
def parser_log_set_flag(subparsers):
...
def parser_log_clear_flag(subparsers):
...
def parser_log_get_flags(subparsers):
...
def parser_log_set_level(subparsers):
...
def parser_log_get_level(subparsers):
...
def parser_log_set_print_level(subparsers):
...
def parser_log_get_print_level(subparsers):
...
# lvol
def parser_bdev_lvol_create_lvstore(subparsers):
...
def parser_bdev_lvol_rename_lvstore(subparsers):
...
def parser_bdev_lvol_create(subparsers):
...
def parser_bdev_lvol_snapshot(subparsers):
...
def parser_bdev_lvol_clone(subparsers):
...
def parser_bdev_lvol_rename(subparsers):
...
def parser_bdev_lvol_inflate(subparsers):
...
def parser_bdev_lvol_decouple_parent(subparsers):
...
def parser_bdev_lvol_resize(subparsers):
...
def parser_bdev_lvol_set_read_only(subparsers):
...
def parser_bdev_lvol_delete(subparsers):
...
def parser_bdev_lvol_delete_lvstore(subparsers):
...
def parser_bdev_lvol_get_lvstores(subparsers):
...
def parser_bdev_raid_get_bdevs(subparsers):
...
def parser_bdev_raid_create(subparsers):
...
def parser_bdev_raid_delete(subparsers):
...
# split
def parser_bdev_split_create(subparsers):
...
def parser_bdev_split_delete(subparsers):
...
# ftl
def parser_bdev_ftl_create(subparsers):
...
def parser_bdev_ftl_delete(subparsers):
...
# nbd
def parser_nbd_start_disk(subparsers):
...
def parser_nbd_stop_disk(subparsers):
...
def parser_nbd_get_disks(subparsers):
...
# net
def parser_net_interface_add_ip_address(subparsers):
...
def parser_net_interface_delete_ip_address(subparsers):
...
def parser_net_get_interfaces(subparsers):
...
# NVMe-OF
def parser_nvmf_set_max_subsystems(subparsers):
...
def parser_nvmf_set_config(subparsers):
...
def parser_nvmf_get_transports(subparsers):
...
def parser_nvmf_get_subsystems(subparsers):
...
def parser_nvmf_create_subsystem(subparsers):
...
def parser_nvmf_delete_subsystem(subparsers):
...
def parser_nvmf_subsystem_allow_any_host(subparsers):
...
# pmem
def parser_bdev_pmem_create_pool(subparsers):
...
def parser_bdev_pmem_get_pool_info(subparsers):
...
def parser_bdev_pmem_delete_pool(subparsers):
...
def parser_bdev_virtio_attach_controller(subparsers):
...
def parser_bdev_virtio_scsi_get_devices(subparsers):
...
def parser_bdev_virtio_detach_controller(subparsers):
...
# ioat
def parser_ioat_scan_copy_engine(subparsers):
...
def parser_bdev_nvme_send_cmd(subparsers):
    ...
    p = subparsers.add_parser('bdev_nvme_send_cmd', aliases=['send_nvme_cmd'], help='NVMe passthrough cmd.')
...
# notifications
def parser_notify_get_types(subparsers):
...
def parser_notify_get_notifications(subparsers):
...
def parser_thread_get_stats(subparsers):
...
for var in dir():
    if var.startswith("parser_"):
        global_parsers.append(var)


parser_construct_aio_bdev = parser_bdev_aio_create
parser_delete_aio_bdev = parser_bdev_aio_delete

parser_construct_compress_bdev = parser_bdev_compress_create
parser_delete_compress_bdev = parser_bdev_compress_delete

parser_construct_crypto_bdev = parser_bdev_crypto_create
parser_delete_crypto_bdev = parser_bdev_crypto_delete

parser_construct_error_bdev = parser_bdev_error_create
parser_delete_error_bdev = parser_bdev_error_delete
parser_bdev_error_inject = parser_bdev_error_inject_error

parser_construct_iscsi_bdev = parser_bdev_iscsi_create
parser_delete_iscsi_bdev = parser_bdev_iscsi_delete

parser_construct_lvol_store = parser_bdev_lvol_create_lvstore
parser_rename_lvol_store = parser_bdev_lvol_rename_lvstore
parser_destroy_lvol_store = parser_bdev_lvol_delete_lvstore
parser_construct_lvol_bdev = parser_bdev_lvol_create
parser_destroy_lvol_bdev = parser_bdev_lvol_delete
parser_snapshot_lvol_bdev = parser_bdev_lvol_snapshot
parser_clone_lvol_bdev = parser_bdev_lvol_clone
parser_rename_lvol_bdev = parser_bdev_lvol_rename
parser_inflate_lvol_bdev = parser_bdev_lvol_inflate
parser_decouple_parent_lvol_bdev = parser_bdev_lvol_decouple_parent
parser_resize_lvol_bdev = parser_bdev_lvol_resize
parser_set_read_only_lvol_bdev = parser_bdev_lvol_set_read_only
parser_get_lvol_stores = parser_bdev_lvol_get_lvstores

parser_construct_malloc_bdev = parser_bdev_malloc_create
parser_delete_malloc_bdev = parser_bdev_malloc_delete
parser_construct_null_bdev = parser_bdev_null_create
parser_delete_null_bdev = parser_bdev_null_delete

parser_construct_ftl_bdev = parser_bdev_ftl_create
parser_delete_ftl_bdev = parser_bdev_ftl_delete
parser_set_bdev_nvme_options = parser_bdev_nvme_set_options
parser_set_bdev_nvme_hotplug = parser_bdev_nvme_set_hotplug
parser_construct_nvme_bdev = parser_bdev_nvme_attach_controller
# parser_delete_nvme_controller = parser_bdev_nvme_detach_controller
parser_get_nvme_controllers = parser_bdev_nvme_get_controllers
parser_apply_nvme_firmware = parser_bdev_nvme_apply_firmware
# parser_send_nvme_cmd = parser_bdev_nvme_send_cmd

parser_construct_ocf_bdev = parser_bdev_ocf_create
parser_delete_ocf_bdev = parser_bdev_ocf_delete
parser_get_ocf_stats = parser_bdev_ocf_get_stats
parser_get_ocf_bdevs = parser_bdev_ocf_get_bdevs

parser_construct_passthru_bdev = parser_bdev_passthru_create
parser_delete_passthru_bdev = parser_bdev_passthru_delete

parser_construct_pmem_bdev = parser_bdev_pmem_create
parser_delete_pmem_bdev = parser_bdev_pmem_delete
parser_create_pmem_pool = parser_bdev_pmem_create_pool
parser_pmem_pool_info = parser_bdev_pmem_get_pool_info
parser_delete_pmem_pool = parser_bdev_pmem_delete_pool

parser_get_raid_bdevs = parser_bdev_raid_get_bdevs
parser_construct_raid_bdev = parser_bdev_raid_create
parser_destroy_raid_bdev = parser_bdev_raid_delete

parser_construct_rbd_bdev = parser_bdev_rbd_create
parser_delete_rbd_bdev = parser_bdev_rbd_delete

parser_get_bdevs_iostat = parser_bdev_get_iostat
parser_get_bdevs = parser_bdev_get_bdevs
parser_set_bdev_qd_sampling_period = parser_bdev_set_qd_sampling_period
parser_set_bdev_qos_limit = parser_bdev_set_qos_limit
parser_enable_bdev_histogram = parser_bdev_enable_histogram
parser_get_bdev_histogram = parser_bdev_get_histogram

parser_construct_split_vbdev = parser_bdev_split_create
parser_destruct_split_vbdev = parser_bdev_split_delete

parser_remove_virtio_bdev = parser_bdev_virtio_detach_controller
parser_get_virtio_scsi_devs = parser_bdev_virtio_scsi_get_devices
parser_construct_virtio_dev = parser_bdev_virtio_attach_controller

parser_scan_ioat_copy_engine = parser_ioat_scan_copy_engine

# parser_start_subsystem_init = parser_framework_start_init
# parser_wait_subsystem_init = parser_framework_wait_init
# parser_context_switch_monitor = parser_framework_monitor_context_switch

parser_get_notification_types = parser_notify_get_types
parser_get_notifications = parser_notify_get_notifications

# parser_get_subsystems = parser_framework_get_subsystems
# parser_get_subsystem_config = parser_framework_get_config

parser_set_bdev_options = parser_bdev_set_options

parser_get_nvmf_subsystems = parser_nvmf_get_subsystems
parser_nvmf_subsystem_create = parser_nvmf_create_subsystem
parser_delete_nvmf_subsystem = parser_nvmf_delete_subsystem
# parser_nvmf_subsystem_add_listener = parser_nvmf_subsystem_add_listener
# parser_nvmf_subsystem_remove_listener = parser_nvmf_subsystem_remove_listener
# parser_nvmf_subsystem_add_ns = parser_nvmf_subsystem_add_ns
# parser_nvmf_subsystem_remove_ns = parser_nvmf_subsystem_remove_ns
# parser_nvmf_subsystem_add_host = parser_nvmf_subsystem_add_host
# parser_nvmf_subsystem_remove_host = parser_nvmf_subsystem_remove_host
# parser_nvmf_subsystem_allow_any_host = parser_nvmf_subsystem_allow_any_host
parser_set_nvmf_target_max_subsystems = parser_nvmf_set_max_subsystems
parser_set_nvmf_target_config = parser_nvmf_set_config
# parser_nvmf_create_transport = parser_nvmf_create_transport
parser_get_nvmf_transports = parser_nvmf_get_transports

# parser_get_initiator_groups = parser_iscsi_get_initiator_groups
parser_add_initiator_group = parser_iscsi_create_initiator_group
parser_add_initiators_to_initiator_group = parser_iscsi_initiator_group_add_initiators
parser_delete_initiators_from_initiator_group = parser_iscsi_initiator_group_remove_initiators
parser_delete_initiator_group = parser_iscsi_delete_initiator_group
# parser_get_target_nodes = parser_iscsi_get_target_nodes
# parser_construct_target_node = parser_iscsi_create_target_node
parser_add_pg_ig_maps = parser_iscsi_target_node_add_pg_ig_maps
parser_delete_pg_ig_maps = parser_iscsi_target_node_remove_pg_ig_maps
# parser_delete_target_node = parser_iscsi_delete_target_node
# parser_get_portal_groups = parser_iscsi_get_portal_groups
parser_add_portal_group = parser_iscsi_create_portal_group
parser_delete_portal_group = parser_iscsi_delete_portal_group
parser_get_iscsi_connections = parser_iscsi_get_connections
parser_target_node_add_lun = parser_iscsi_target_node_add_lun
parser_set_iscsi_target_node_auth = parser_iscsi_target_node_set_auth
parser_set_iscsi_options = parser_iscsi_set_options
parser_get_iscsi_global_params = parser_iscsi_get_options
parser_set_iscsi_discovery_auth = parser_iscsi_set_discovery_auth
parser_add_iscsi_auth_group = parser_iscsi_create_auth_group
parser_delete_iscsi_auth_group = parser_iscsi_delete_auth_group
parser_add_secret_to_iscsi_auth_group = parser_iscsi_auth_group_add_secret
parser_delete_secret_from_iscsi_auth_group = parser_iscsi_auth_group_remove_secret
parser_get_iscsi_auth_groups = parser_iscsi_get_auth_groups

parser_set_log_print_level = parser_log_set_print_level
parser_get_log_print_level = parser_log_get_print_level
parser_set_log_level = parser_log_set_level
parser_get_log_level = parser_log_get_level
# parser_set_log_flag = parser_log_set_flag
parser_clear_log_flag = parser_log_clear_flag
parser_get_log_flags = parser_log_get_flags

parser_start_nbd_disk = parser_nbd_start_disk
parser_stop_nbd_disk = parser_nbd_stop_disk
parser_get_nbd_disks = parser_nbd_get_disks

parser_add_ip_address = parser_net_interface_add_ip_address
parser_delete_ip_address = parser_net_interface_delete_ip_address
parser_get_interfaces = parser_net_get_interfaces

parser_get_rpc_methods = parser_rpc_get_methods

parser_kill_instance = parser_spdk_kill_instance
parser_get_spdk_version = parser_spdk_get_version

# parser_get_scsi_devices = parser_scsi_get_devices

# parser_enable_tpoint_group = parser_trace_enable_tpoint_group
# parser_disable_tpoint_group = parser_trace_disable_tpoint_group
# parser_get_tpoint_group_mask = parser_trace_get_tpoint_group_mask

# parser_vhost_create_scsi_controller = parser_construct_vhost_scsi_controller
# parser_add_vhost_scsi_lun = parser_vhost_scsi_controller_add_target
# parser_remove_vhost_scsi_target = parser_vhost_scsi_controller_remove_target
# parser_construct_vhost_blk_controller = parser_vhost_create_blk_controller
# parser_remove_vhost_controller = parser_vhost_delete_controller
# parser_get_vhost_controllers = parser_vhost_get_controllers
# parser_set_vhost_controller_coalescing = parser_vhost_controller_set_coalescing
# parser_construct_vhost_nvme_controller = parser_vhost_create_nvme_controller
# parser_add_vhost_nvme_ns = parser_vhost_nvme_controller_add_ns
