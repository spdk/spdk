...
def construct_lvol_store(args):
    params = {'base_name': args.base_name, 'lvs_name': args.lvs_name}
...
p.add_argument('base_name', help='base bdev name')
p.add_argument('lvs_name', help='friendly name for lvol store')
...
p.add_argument('-b', '--bdev', help='bdev name', required=True)
