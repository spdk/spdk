...
def get_reactors_rusage(args):
    print_dict(jsonrpc_call('get_reactors_rusage'))

p = subparsers.add_parser('get_reactors_rusage', help='List rusage information for all reactors')
p.set_defaults(func=get_reactors_rusage)
