    ...
    *** The Portal/Initiator Groups must be precreated ***""")
    ...
    def nvmf_create_transport(args):
        rpc.nvmf.nvmf_create_transport(args.client,
                                       ...
                                       max_shared_buffer_num=args.max_shared_buffer_num)
    ...
    p.add_argument('-n', '--max-shared-buffer-num', help='Max number of shared buffer number of the transport', type=int)
