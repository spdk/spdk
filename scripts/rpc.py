...
if __name__ == "__main__":
    ...
    p.add_argument('--delay-cmd-submit',
                   help='Delay NVMe command submission to allow batching of multiple commands',
                   action='store_true', dest='delay_cmd_submit', default=None)
    p.add_argument('--no-delay-cmd-submit',
                   help='Do not delay NVMe command submission',
