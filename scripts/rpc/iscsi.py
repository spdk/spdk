...
def add_initiator_to_initiator_group(args):
    ...
    params = {'tag': args.tag, 'initiators': initiators, 'netmasks': netmasks}
    args.client.call('add_initiator_to_initiator_group', params, verbose=args.verbose)
...
def delete_initiator_from_initiator_group(args):
    ...
    params = {'tag': args.tag, 'initiators': initiators, 'netmasks': netmasks}
    args.client.call('delete_initiator_from_initiator_group', params, verbose=args.verbose)
