...
def bdev_histogram_enable(client, name):
    ...
    """
    params = {'name': name}
    return client.call('bdev_histogram_enable', params)


def bdev_histogram_disable(client, name):
    ...
    """
    params = {'name': name}
    return client.call('bdev_histogram_disable', params)


def bdev_histogram_get(client, name):
    ...
    """
    params = {'name': name}
    return client.call('bdev_histogram_get', params)
