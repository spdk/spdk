...
def set_bdev_qos_limit(client, name, rw_ios_per_sec=int, rw_mbytes_per_sec=int):
    ...
    params = {}
    params['name'] = name
    if int(rw_ios_per_sec) >= 0:
        params['rw_ios_per_sec'] = int(rw_ios_per_sec)
    if int(rw_mbytes_per_sec) >= 0:
        params['rw_mbytes_per_sec'] = int(rw_mbytes_per_sec)
