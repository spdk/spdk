...
def construct_raid_bdev(client, name, strip_size, strip_size_kb, raid_level, base_bdevs):
    ...
    Returns:
        None
    """
    params = {'name': name, 'strip_size': strip_size, 'strip_size_kb': strip_size_kb, 'raid_level': raid_level, 'base_bdevs': base_bdevs}
