...
def construct_malloc_bdev(args):
    ...
    print_array(args.client.call('construct_malloc_bdev', params))
...
def construct_null_bdev(args):
    ...
    print_array(args.client.call('construct_null_bdev', params))
...
def construct_aio_bdev(args):
    ...
    print_array(args.client.call('construct_aio_bdev', params))
...
def construct_rbd_bdev(args):
    ...
    print_array(args.client.call('construct_rbd_bdev', params))
...
def get_bdevs(args):
    print_dict(args.client.call('get_bdevs'))
