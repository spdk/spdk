...
def get_pvols(client, category):
    """Get list of pvols based on category
...
def construct_pvol(client, name, strip_size, raid_level, base_bdevs):
    """Construct pooled device

    Args:
        name: user defined pvol name
        strip_size: strip size of pvol in KB, supported values like 8, 16, 32, 64, 128, 256, 512, 1024 etc
        raid_level: raid level of pvol, supported values 0
