def set_bdev_options(client, bdev_io_pool_size, bdev_io_cache_size):
    """Set parameters for the bdev subsystem.

    Args:
        bdev_io_pool_size: number of bdev_io structures in shared buffer pool
        bdev_io_cache_size: maximum number of bdev_io structures cached per thread
    """
    params = {}
