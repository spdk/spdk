...
def zdev_ocssd_attach_controller(client, name, trtype, traddr):
    """Creates Open Channel zdevs on specified Open Channel controller

    Args:
        name: name of the zdev
        trtype: transport type
        traddr: transport address
    """
    params = {'name': name,
    ...
    return client.call('zdev_ocssd_attach_controller', params)


def zdev_ocssd_detach_controller(client, name):
    ...
    return client.call('zdev_ocssd_detach_controller', params)
