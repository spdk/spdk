...
def bdev_opal_create(client, nvme_ctrlr_name, nsid, locking_range_id, range_start, range_length, password, bdev_name):
    ...
    Args:
        ...
        bdev_name: name for this new created bdev (optional)
