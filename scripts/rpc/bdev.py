...
def delete_null_bdev(client, name):
    ...
    Args:
        bdev_name: name of null bdev to delete
    """
    params = {'name': name}
...
def delete_nvme_bdev(client, name):
    """Remove NVMe bdev from the system.

    Args:
        bdev_name: name of NVMe bdev to delete
    """
    params = {'name': name}
    return client.call('delete_nvme_bdev', params)
...
def delete_rbd_bdev(client, name):
    ...
    Args:
        bdev_name: name of rbd bdev to delete
    """
    params = {'name': name}
...
def delete_passthru_bdev(client, name):
    ...
    Args:
        bdev_name: name of pass through bdev to delete
    """
    params = {'name': name}
