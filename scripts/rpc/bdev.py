...
def set_bdev_nvme_options(client, action_on_timeout=None, timeout_s=None, retry_count=None,
    ...
    Args:
        ...
        timeout: Timeout for each command, in seconds. If 0, don't track timeouts. (optional)
        ...
        nvme_hotplug_poll_period_us: how often the hotplug is processed for insert and remove events. (optional)
    """
    params = {}
