...
def bdev_size_adapter_create(client, name, base_bdev):
    ...
    return client.call('bdev_size_adapter_create', params)


def bdev_size_adapter_delete(client, name):
    ...
    """
    params = {'name': name}
    return client.call('bdev_size_adapter_delete', params)
