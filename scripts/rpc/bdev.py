...
def construct_ftl_bdev(client, name, trtype, traddr, punits, power_loss_recovery, uuid=None, cache=None):
    """Construct FTL bdev
    ...
    Args:
        ...
        power_loss_recovery: allow for partial restore after dirty shutdown
    """
    params = {'name': name,
              'trtype': trtype,
              'traddr': traddr,
