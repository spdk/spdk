...
def get_vhost_controllers(args):
    print_dict(args.client.call(
        'get_vhost_controllers', verbose=args.verbose))
...
def construct_vhost_blk_controller(args):
    ...
    args.client.call('construct_vhost_blk_controller',
                     params, verbose=args.verbose)


def remove_vhost_controller(args):
    params = {'ctrlr': args.ctrlr}
    args.client.call('remove_vhost_controller',
                     params, verbose=args.verbose)
...
def set_vhost_controller_coalescing(args):
    ...
    args.client.call('set_vhost_controller_coalescing', params, verbose=args.verbose)
...
def construct_virtio_user_scsi_bdev(args):
    ...
    print_dict(args.client.call('construct_virtio_user_scsi_bdev', params, verbose=args.verbose))
