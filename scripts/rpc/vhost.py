...
def remove_virtio_blk_bdev(client, name):
    """Remove a Virtio-BLK device
    This will delete bdev exposed by this device.
    Args:
        name: virtio block bdev name
    """
    params = {'name': name}
    return client.call('remove_virtio_blk_bdev', params)
