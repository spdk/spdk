...
def construct_lvol_store(args):
    ...
    print_array(args.client.call('construct_lvol_store', params, verbose=args.verbose))
...
def construct_lvol_bdev(args):
    ...
    if (args.uuid and args.lvs_name) or (not args.uuid and not args.lvs_name):
        ...
        print_array(args.client.call('construct_lvol_bdev', params, verbose=args.verbose))
...
def destroy_lvol_store(args):
    ...
    if (args.uuid and args.lvs_name) or (not args.uuid and not args.lvs_name):
        ...
        if args.lvs_name:
            params['lvs_name'] = args.lvs_name
        args.client.call('destroy_lvol_store', params, verbose=args.verbose)


def get_lvol_stores(args):
    print_dict(args.client.call('get_lvol_stores', verbose=args.verbose))
