...
def nvme_cmd(client, name, cmd_type, data_direction, cmdbuf,
...
def nvme_device_list(client, type='all'):
    ...
    Returns:
        Number of NVMe devices, .name array of NVMe devices.
    """
    params = {'type': type}

    return client.call('nvme_device_list', params)
