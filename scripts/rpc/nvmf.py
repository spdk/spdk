...
def nvmf_create_transport(client,
    ...
    Args:
        ...
        max_shared_buffer_num: Max shared buffer number of the transport (optional)
    ...
    if max_shared_buffer_num:
        params['max_shared_buffer_num'] = max_shared_buffer_num
