...
section_to_method = {
    "Bdev": get_bdev_options_json,
    "AIO": get_aio_bdev_json,
    "Malloc": get_malloc_bdev_json,
    "Nvme": get_nvme_bdev_json,
    "Pmem": get_pmem_bdev_json,
    "Split": get_split_bdev_json,
    "Nvmf": get_nvmf_options_json,
    "Subsystem": get_nvmf_subsystem_json,
    "VhostScsi": get_vhost_scsi_json,
    "VhostBlk": get_vhost_blk_json,
    "VhostNvme": get_vhost_nvme_json,
    "VirtioUser": get_virtio_user_json,
    "iSCSI": get_iscsi_options_json,
    "PortalGroup": get_iscsi_portal_group_json,
    "InitiatorGroup": get_iscsi_initiator_group_json,
    "TargetNode": get_iscsi_target_node_json
}
