    ...
    for section in config.sections():
        if section == "Nvme":
            ...
            for item in nvme_json:
                subsystem['bdev'][item['method']].append(item)
        elif section == "Malloc":
            ...
            subsystem['bdev'][virtio_json['method']].append(virtio_json)
        elif section == "Split":
            split_json = get_split_json(config)
            for split in split_json:
                subsystem['bdev'][split['method']].append(split)
        elif section == "iSCSI":
            iscsi_json = get_iscsi_json(config, section)
            subsystem['iscsi'][iscsi_json['method']].append(iscsi_json)
        elif section == "Pmem":
