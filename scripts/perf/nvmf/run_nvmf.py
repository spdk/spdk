...
class Target(Server):
    ...
    def measure_sar(self, delay, interval, count, results_dir):
        out = subprocess.check_output("sar -P ALL 5 3", shell=True).decode(encoding="utf-8")
...
class SPDKTarget(Target):
    ...
    def gen_tgt_conf(self):
        ...
        self.log_print("numa_list={} core_mask={}".format(numa_list, core_mask))
        ...
        self.log_print("SPDK Target created configuration file:")
        self.log_print("\n".join([global_section, nvme_section, subsystems_section]))
...
if __name__ == "__main__":
    ...
    # target_obj.measure_sar(0, 5, 10, target_results_dir)
