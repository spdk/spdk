...
parser.add_argument('-c', '--ctrl-type', default="spdk_vhost_scsi", type=str,
                    ...
                    Possible options: spdk_vhost_scsi, spdk_vhost_blk, kernel_vhost\
...
parser.add_argument('--kernel-cpu', default=None, type=int,
                    help="Limit kernel vhost to this number of CPUs. Default: none")
...
if args.kernel_cpu:
    kernel_cpu_arg = "--limit-kernel-vhost=%s" % args.kernel_cpu
if args.max_disks > 0:
