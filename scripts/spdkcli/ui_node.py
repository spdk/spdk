        ...
        try:
            ...
            if self.shell.interactive and\
                command in ["create", "delete", "delete_all", "add_initiator",
                            "allow_any_host", "split_bdev_create", "add_lun",
...
class UISplitBdev(UIBdev):
    ...
    def ui_command_split_bdev_create(self, base_bdev, split_count, split_size_mb=None):
        """
        ...
        ret_name = self.get_root().split_bdev_create(base_bdev=base_bdev,
