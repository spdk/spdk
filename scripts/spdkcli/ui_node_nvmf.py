...
class UINVMfSubsystems(UINode):
    ...
    def ui_command_create(self, nqn, serial_number, listen=None, hosts=None, namespaces=None,
        ...
        Arguments:
            ...
            listen - Optional parameter. Comma separated list of Listen
                     <trtype:transport_name-traddr:address-trsvcid:port_id,
                      trtype:transport_name-traddr:address-trsvcid:port_id>.
            hosts - Optional parameter. Whitespace separated list of host nqn
                    <nqn1 nqn2>
            namespaces - Optional parameter. Whitespace separated list of namespaces
                         <bdev1:1=bdev2:2>
