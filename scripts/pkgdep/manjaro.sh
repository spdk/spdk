...
pamac install --no-confirm python-configshell-fb
pamac install --no-confirm python-pyelftools
pamac install --no-confirm python-ijson
pamac install --no-confirm python-magic
pamac install --no-confirm python-grpcio
pamac install --no-confirm python-grpcio-tools
pamac install --no-confirm python-pyyaml
