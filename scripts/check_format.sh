...
if hash shellcheck 2>/dev/null; then
	...
	SHCK_EXCLUDE="SC1083,SC2002,SC2010,SC2046,SC2086,SC2097,SC2098"
	...
	SHCK_EXCLUDE="$SHCK_EXCLUDE,SC1090,SC1091,SC2015,SC2016,SC2034,SC2119,SC2120,SC2148,SC2153,SC2154,\
SC2164,SC2174,SC2001,SC2206,SC2207,SC2223"
