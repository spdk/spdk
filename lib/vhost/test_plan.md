...
Tests 1-10 should be run on vhost and guest.
...
#### Test Case 8 - vhost initiator test with multiqueue
...
### Test Case 9 - vhost initator test with multiple socket
...
### Test Case 10 - vhost initiator test with unmap
