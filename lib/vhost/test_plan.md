...
This test configures a SPDK vhost subsystem backed by pmem
...
- create vhost subsystems with 10 pmem bdevs namespaces.
- run FIO with workload parameters: blocksize=128k, iodepth=64,
...
- disconnect kernel initiator from vhost subsystems.
- delete vhost subsystems from configuration.
