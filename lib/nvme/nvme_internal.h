...
int nvme_poll_group_add_qpair_fd(struct spdk_nvme_qpair *qpair);
...
struct spdk_nvme_ns *nvme_ctrlr_find_ns(struct spdk_nvme_ctrlr *ctrlr, uint32_t nsid);
...
void	nvme_ns_mark_inactive(struct spdk_nvme_ns *ns);
