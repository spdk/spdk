...
if [ $SPDK_TEST_VHOST -eq 1 ]; then
	...
	if [ $RUN_NIGHTLY -eq 1 ]; then
		...
		timing_enter fs_integrity_lvol_scsi
		run_test ./test/vhost/spdk_vhost.sh --fs-integrity-lvol-scsi
		timing_exit fs_integrity_lvol_scsi

		timing_enter fs_integrity_lvol_blk
		run_test ./test/vhost/spdk_vhost.sh --fs-integrity-lvol-blk
		timing_exit fs_integrity_lvol_blk
	fi
