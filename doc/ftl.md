...
`construct_nvme_bdev` RPC call, which are:
 - bdev's name
...
```
$ scripts/rpc.py construct_nvme_bdev -b nvme0 -t PCIe -m ftl -l 0-3 -a 00:0a.0
{
        "name": "nvme0",
        "uuid": "b4624a89-3174-476a-b9e5-5fd27d73e870"
}
$ scripts/rpc.py construct_nvme_bdev -b nvme1 -t PCIe -m ftl -l 0-3 -a 00:0a.0 -u e9825835-b03c-49d7-bc3e-5827cbde8a88
{
        "name": "nvme1",
