...
Affinity groups allow users to delegate a group of cores to perform specific or expensive
operations and isolate them from the rest of the system.

Groups are defined by the following format:
...
- Each undefined group is non-exclusive and contains all free (unassigned) cores.
...
The following list of affinity groups defines two groups: 'vhost' with delegated CPUs 1 to 7,
