# Block Device User Guide {#bdev_user_guide}
...
## Creating a GPT partition table using NBD {#bdev_ug_nbd}
...
To create NBD bdev user should use `start_nbd_disk` RPC command.

Parameters

Name                    | Optional | Type        | Description
----------------------- | -------- | ----------- | -----------
bdev_name               | Required | string      | Blockdev name to be exported
nbd_device              | Required | string      | Nbd device name to be assigned
...
Name                    | Optional | Type        | Description
----------------------- | -------- | ----------- | -----------
nbd_device              | Required | string      | Nbd device name to be stopped
...
Name                    | Optional | Type        | Description
----------------------- | -------- | ----------- | -----------
nbd_device              | Optional | string      | Path of the nbd device
...
## Logical valume store {#bdev_ug_lvol_store}
...
The SPDK pmem bdev driver uses pmemblk pool as the target for block I/O operations.
