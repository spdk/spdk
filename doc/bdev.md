...
should be used only for debug purpose. To remove particular bdev please use
bdev specific delete command.
...
To remove block device representation of NVMe device use delete_nvme_bdev command.
...
To delete null bdev use delete_null_bdev command.
...
To delete aio bdev use delete_aio_bdev command.
...
To remove block device representation use delete_rbd_bdev command.
...
To remove block device representation use delete_pmem_bdev command.
