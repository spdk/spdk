...
Notice: send_nvme_cmd requires user to guarentee the correctness of NVMe command itself, and also optional parameters. Illegal command
contents or mismatching buffer size would cause SPDK's crash.
...
Name                    | Type        | Description
----------------------- | ----------- | -----------
device_names            | array       | Array of names of available NVMe devices.
