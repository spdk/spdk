...
Name                        | Optional | Type    | Description
--------------------------- | -------- | --------| -----------
auth_file                   | Optional | string  | Path to CHAP shared secret file (default: "/usr/local/etc/spdk/auth.conf")
...
no_authfile                 | Optional | boolean | Disable loadin CHAP shared secret file (default: `false`)
...
secrets                     | Required | array   | Not empty array of @ref rpc_add_iscsi_auth_group_secret objects

### secret {#rpc_add_iscsi_auth_group_secret}

Name                        | Type    | Description
--------------------------- | --------| -----------
user                        | string  | Unidirectional CHAP name
secret                      | string  | Unidirectional CHAP secret
muser                       | string  | Bidirectional CHAP name
msecret                     | string  | Bidirectional CHAP secret
...
## set_iscsi_target_node_auth method {#rpc_target_node_add_lun}
