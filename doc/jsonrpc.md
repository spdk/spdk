...
## sock_get_options {#rpc_sock_get_options}
...
## sock_set_options {#rpc_sock_set_options}
...
----------------------- | -------- | ----------- | -----------
impl_name               | Required | string      | Name of socket implementation, e.g. posix
recv_pipe_size          | Optional | number      | Size of socket receive pipe in bytes
