...
max_io_size             | Optional | number      | Maximum I/O size
max_subsystems          | Optional | number      | Maximum number of NVMf subsystems
io_unit_size            | Optional | number      | I/O unit size
...
Set global configuration of NVMf target.  This RPC may only be called before subsystems
have been initialized.
...
Name                    | Optional | Type        | Description
----------------------- | -------- | ----------- | -----------
acceptor-poll-rate      | Optional | number      | How often the acceptor polls for incoming connections
