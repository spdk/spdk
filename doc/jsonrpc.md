...
timeout                     | number  | Timeout in seconds to nop-in request to the initiator (default: 60)
nop_in_interval             | number  | Time interval in secs between nop-in requests by the target (default: 60)
...
req_discovery_auth_mutual   | boolean | CHAP for discovery session should be mutual (default: `false`)
...
mutual_chap                 | boolean | CHAP authentication should be mutual (`true`) or bidirectional (`false`)
...
mutual_chap                 | Optional | boolean | CHAP authentication should be bidirectional
...
target_addr                 | string  | CHAP authentication should be disabled for this target
