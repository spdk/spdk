...
current command. There is ongoing effort to customize those messages but some RPC methods just return "Invalid parameters"
...
block_size              | Required | number      | Block size in bytes. Must by multiple of 512.
