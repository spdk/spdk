...
mode                    | Required | number      | OCF cache mode ('wt' or 'pt')
cache_bdev_name         | Required | number      | Name of underlying cache bdev
core_bdev_name          | Optional | string      | Name of unerlying core bdev
