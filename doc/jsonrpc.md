...
## construct_aio_bdev {#rpc_construct_null_bdev}
...
## delete_nvme {#rpc_delete_null_bdev}
...
Because of it is going to be deprecated it delibertly won't be documented.
...
Because it is going to be deprecated it delibertly won't be documented.
