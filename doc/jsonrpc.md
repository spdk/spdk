...
Block until subsystems have been initialized and the RPC system state is running.
If the application is already running, this call will return mmediately. This RPC can be called at any time.
