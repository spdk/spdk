...
Name of the created logical volume block device is returned.
...
Name                    | Optional | Type        | Description
----------------------- | -------- | ----------- | -----------
lvol_name               | Required | string      | Logical volume to create a snapshot from
snapshot_name           | Required | string      | Name for the newly created snapshot

### Response

Name of the created logical volume snapshot is returned.
...
Name                    | Optional | Type        | Description
----------------------- | -------- | ----------- | -----------
snapshot_name           | Required | string      | Snapshot to clone
clone_name              | Required | string      | Name of the logical volume to create

### Response

Name of the created logical volume clone is returned.
...
Name                    | Optional | Type        | Description
----------------------- | -------- | ----------- | -----------
old_name                | Required | string      | Existing logical volume name
...
Name                    | Optional | Type        | Description
----------------------- | -------- | ----------- | -----------
name                    | Required | string      | Name of the logical volume to resize
size                    | Required | number      | Desired size of logical volume in bytes
...
Name                    | Optional | Type        | Description
----------------------- | -------- | ----------- | -----------
name                    | Required | string      | Name of the logical volume to destroy
...
Name                    | Optional | Type        | Description
----------------------- | -------- | ----------- | -----------
name                    | Required | string      | Name of the logical volume to inflate
...
Name                    | Optional | Type        | Description
----------------------- | -------- | ----------- | -----------
name                    | Required | string      | Name of the logical volume to decouple the parent of it
