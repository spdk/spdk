...
Keyword 'Dev' is deprecated and will be removed, but it is still supported.
...
vhost_scsi.c: 840:spdk_vhost_scsi_dev_add_target: *NOTICE*: Controller vhost_scsi0_socket: defined device 'Dev 1' using lun 'Malloc0'
vhost_scsi.c: 840:spdk_vhost_scsi_dev_add_target: *NOTICE*: Controller vhost_scsi0_socket: defined device 'Dev 5' using lun 'Malloc1'
