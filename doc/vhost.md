...
took into account - in this case always CPU 0. To achieve optimal performance
...
on CPUs 0 and 1, QEMU on CPUs 2 and 3.

~~~{.sh}
host:~# ./dpdk/usertools/cpu_layout.py
======================================================================
...
This system has 2 cpu sockets. For this example we will only use the Socket 0.
