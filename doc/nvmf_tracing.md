# SPDK Target Tracepoints {#spdk_tgt_tracepoints}
...
To enable the RDMA tracepoints in an SPDK target application, set the
TpointGroupMask to 0xFF

~~~
[Global]
  ...
  TpointGroupMask 0xFF
  ...
~~~
