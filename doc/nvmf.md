...
NVMe qulified names or NQNs are defined in section 7.9 of the
...
SPDk mudules use this formal definition (provided below) when validating NQNs.
...
"maximum name is 223 bytes in length", and will reject any names longer exceeding that limit.

Please note that the following types from the definition above have been defined previously:
