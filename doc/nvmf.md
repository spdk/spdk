...
It requires an RDMA-capable NIC with its corresponding OFED [OFED download] (https://downloads.openfabrics.org/OFED/)
software package installed to run.
...
many 2MB hugepages reserved at runtime. Some of NICs report as many as 2048 for the
