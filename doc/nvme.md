...
Those pass the I/O or admin commands via a ring to thread that process them using
spdk_nvme_io_msg_process().

Ioctls that request information attained when attaching NVMe controller receive
