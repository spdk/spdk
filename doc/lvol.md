...
Inflation mechanism allocates unallocated clusters in the inflated blob and copies data from backing devices (e.g. snapshots or zeroes_dev). As a result of this operation the blob stops being thin provisioned and all dependencies are removed.
