...
userspace framework providing networking functionality. It is build around the concept of
...
info. For example, you can special a Listen address in NVMe-oF subsystem
...
vpp implemenation(if compiled in SPDK program), and only one implementaion can
successfully listen on the provvided portal.
