...
def add_parser(subparsers):
    ...
    def fsdev_set_opts(args):
        print_json(args.client.fsdev_set_opts(fsdev_io_pool_size=args.fsdev_io_pool_size,
    ...
    def fsdev_aio_create(args):
        print_json(args.client.fsdev_aio_create(name=args.name, root_path=args.root_path,
    ...
    def fsdev_aio_delete(args):
        print_json(args.client.fsdev_aio_delete(name=args.name))
